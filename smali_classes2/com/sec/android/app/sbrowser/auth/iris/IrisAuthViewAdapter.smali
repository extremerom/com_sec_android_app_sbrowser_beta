.class public Lcom/sec/android/app/sbrowser/auth/iris/IrisAuthViewAdapter;
...
.method public constructor <init>(Landroid/app/Activity;Lcom/sec/android/app/sbrowser/auth/AuthView;)V
    ...
    iput-object p1, p0, Lcom/sec/android/app/sbrowser/auth/iris/IrisAuthViewAdapter;->mActivity:Landroid/app/Activity;

    iput-object p2, p0, Lcom/sec/android/app/sbrowser/auth/iris/IrisAuthViewAdapter;->mView:Lcom/sec/android/app/sbrowser/auth/AuthView;
    ...
    iput-object p1, p0, Lcom/sec/android/app/sbrowser/auth/iris/IrisAuthViewAdapter;->mAuthenticator:Lcom/sec/android/app/sbrowser/auth/Authenticator;
    ...
    iput-object p1, p0, Lcom/sec/android/app/sbrowser/auth/iris/IrisAuthViewAdapter;->mSettings:Lcom/sec/android/app/sbrowser/common/secret_mode/SecretModeSettings;
    ...
    iput-object p1, p0, Lcom/sec/android/app/sbrowser/auth/iris/IrisAuthViewAdapter;->mLockModel:Lcom/sec/android/app/sbrowser/auth/LockModel;
...
.method public cancelAuth()V
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/auth/iris/IrisAuthViewAdapter;->mAuthenticator:Lcom/sec/android/app/sbrowser/auth/Authenticator;
...
.method public onAuthBlock()V
    ...
    const-string v0, "IrisAuthViewAdapter"

    const-string v1, "onAuthBlock"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/auth/iris/IrisAuthViewAdapter;->mSettings:Lcom/sec/android/app/sbrowser/common/secret_mode/SecretModeSettings;

    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/common/secret_mode/SecretModeSettings;->lockBiometricsAuth()V

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/auth/iris/IrisAuthViewAdapter;->mView:Lcom/sec/android/app/sbrowser/auth/AuthView;
...
.method public onAuthError(ILjava/lang/String;)V
    ...
    iget-object p1, p0, Lcom/sec/android/app/sbrowser/auth/iris/IrisAuthViewAdapter;->mView:Lcom/sec/android/app/sbrowser/auth/AuthView;

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/auth/iris/IrisAuthViewAdapter;->mActivity:Landroid/app/Activity;
...
.method public onAuthFail()V
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/auth/iris/IrisAuthViewAdapter;->mView:Lcom/sec/android/app/sbrowser/auth/AuthView;

    iget-object v1, p0, Lcom/sec/android/app/sbrowser/auth/iris/IrisAuthViewAdapter;->mActivity:Landroid/app/Activity;
...
.method public onAuthLockout(J)V
    ...
    const-string v1, "IrisAuthViewAdapter"
...
.method public onAuthRetry()V
    ...
    const-string p0, "IrisAuthViewAdapter"
...
.method public startAuth()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/auth/iris/IrisAuthViewAdapter;->mActivity:Landroid/app/Activity;
    ...
    :cond_1
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/auth/iris/IrisAuthViewAdapter;->mLockModel:Lcom/sec/android/app/sbrowser/auth/LockModel;
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/auth/iris/IrisAuthViewAdapter;->mAuthenticator:Lcom/sec/android/app/sbrowser/auth/Authenticator;
    ...
    iget-object v2, p0, Lcom/sec/android/app/sbrowser/auth/iris/IrisAuthViewAdapter;->mView:Lcom/sec/android/app/sbrowser/auth/AuthView;
