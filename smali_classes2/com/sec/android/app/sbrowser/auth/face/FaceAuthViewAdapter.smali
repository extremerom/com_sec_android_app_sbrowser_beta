.class public Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter;
...
.method public constructor <init>(Landroid/app/Activity;Lcom/sec/android/app/sbrowser/auth/AuthView;)V
    ...
    iput-object p1, p0, Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter;->mActivity:Landroid/app/Activity;

    iput-object p2, p0, Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter;->mView:Lcom/sec/android/app/sbrowser/auth/AuthView;
    ...
    iput-object p1, p0, Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter;->mAuthenticator:Lcom/sec/android/app/sbrowser/auth/Authenticator;
    ...
    iput-object p1, p0, Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter;->mSettings:Lcom/sec/android/app/sbrowser/common/secret_mode/SecretModeSettings;
    ...
    iput-object p1, p0, Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter;->mLockModel:Lcom/sec/android/app/sbrowser/auth/LockModel;

    return-void
.end method

.method public static bridge synthetic a(Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter;)Lcom/sec/android/app/sbrowser/auth/AuthView;
    .locals 0

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter;->mView:Lcom/sec/android/app/sbrowser/auth/AuthView;
...
.method public cancelAuth()V
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter;->mAuthenticator:Lcom/sec/android/app/sbrowser/auth/Authenticator;
...
.method public onAuthBlock()V
    ...
    const-string v0, "FaceAuthViewAdapter"

    const-string v1, "onAuthBlock"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter;->mSettings:Lcom/sec/android/app/sbrowser/common/secret_mode/SecretModeSettings;
...
.method public onAuthError(ILjava/lang/String;)V
    ...
    iget-object p1, p0, Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter;->mView:Lcom/sec/android/app/sbrowser/auth/AuthView;

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter;->mActivity:Landroid/app/Activity;
...
.method public onAuthFail()V
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter;->mView:Lcom/sec/android/app/sbrowser/auth/AuthView;

    iget-object v1, p0, Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter;->mActivity:Landroid/app/Activity;
...
.method public onAuthLockout(J)V
    ...
    const-string v1, "FaceAuthViewAdapter"
...
.method public onAuthRetry()V
    ...
    const-string p0, "FaceAuthViewAdapter"
...
.method public onAuthSuccess()V
    ...
    new-instance v1, Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter$1;

    invoke-direct {v1, p0}, Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter$1;-><init>(Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter;)V
...
.method public startAuth()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter;->mActivity:Landroid/app/Activity;
    ...
    :cond_1
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter;->mLockModel:Lcom/sec/android/app/sbrowser/auth/LockModel;
    ...
    const-string v1, "Start Face Authenticate"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter;->mAuthenticator:Lcom/sec/android/app/sbrowser/auth/Authenticator;

    new-instance v1, Lcom/sec/android/app/sbrowser/auth/AuthParam;

    iget-object v2, p0, Lcom/sec/android/app/sbrowser/auth/face/FaceAuthViewAdapter;->mView:Lcom/sec/android/app/sbrowser/auth/AuthView;
    ...
    invoke-interface {p0}, Lcom/sec/android/app/sbrowser/auth/AuthView;->showDialogIfRequired()V
