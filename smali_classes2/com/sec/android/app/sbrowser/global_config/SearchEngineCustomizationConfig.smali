.class public Lcom/sec/android/app/sbrowser/global_config/SearchEngineCustomizationConfig;
...
.method public constructor <init>()V
    ...
    const-string v0, "SearchEngineCustomization"
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/global_config/SearchEngineCustomizationConfig;->mFieldTypeMap:Ljava/util/Map;
    ...
    const-string v1, "addSearchEngineList"
...
.method public getFieldTypeMap()Ljava/util/Map;
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/global_config/SearchEngineCustomizationConfig;->mFieldTypeMap:Ljava/util/Map;
...
.method public onFeatureConfigUpdated(Landroid/content/Context;)V
    ...
    const-string v1, "SearchEngineCustomization"
    ...
    :cond_0
    const-string v0, "addSearchEngineList"

    const-string v2, ""

    invoke-virtual {p0, p1, v0, v2}, Lcom/sec/android/app/sbrowser/common/model/global_config/GlobalConfigFeature;->getString(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    new-instance v2, Ljava/lang/StringBuilder;

    const-string v3, "onFeatureConfigUpdated search engine list : "
    ...
    const-string v2, "able_to_add_search_engine_list"

    invoke-interface {v1, v2, v0}, Landroid/content/SharedPreferences$Editor;->putString(Ljava/lang/String;Ljava/lang/String;)Landroid/content/SharedPreferences$Editor;

    move-result-object v0

    const-string v1, "need_to_update_search_engine_list"
    ...
    invoke-virtual {v0, v2}, Lcom/sec/android/app/sbrowser/common/model/global_config/FetchBuilder;->setUseETag(Z)Lcom/sec/android/app/sbrowser/common/model/global_config/FetchBuilder;

    move-result-object v0

    new-instance v1, Lcom/sec/android/app/sbrowser/global_config/SearchEngineCustomizationConfig$1;

    invoke-direct {v1, p0}, Lcom/sec/android/app/sbrowser/global_config/SearchEngineCustomizationConfig$1;-><init>(Lcom/sec/android/app/sbrowser/global_config/SearchEngineCustomizationConfig;)V
