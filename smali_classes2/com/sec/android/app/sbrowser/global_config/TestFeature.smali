.class public Lcom/sec/android/app/sbrowser/global_config/TestFeature;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/global_config/TestFeature;->mFieldTypeMap:Ljava/util/Map;
    ...
    const-string p0, "CoolingTimeMillis"
    ...
    const-string v1, "TncTitle"

    invoke-interface {v0, v1, p0}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "TncConfirmDefault"
...
.method public getFieldTypeMap()Ljava/util/Map;
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/global_config/TestFeature;->mFieldTypeMap:Ljava/util/Map;
...
.method public onFeatureConfigUpdated(Landroid/content/Context;)V
    ...
    new-instance v0, Lcom/sec/android/app/sbrowser/global_config/TestFeatureManager;

    invoke-direct {v0}, Lcom/sec/android/app/sbrowser/global_config/TestFeatureManager;-><init>()V

    invoke-virtual {v0, p1}, Lcom/sec/android/app/sbrowser/global_config/TestFeatureManager;->getUpdatedNotificationCount(Landroid/content/Context;)I

    move-result v1

    add-int/lit8 v1, v1, 0x1

    invoke-virtual {v0, p1, v1}, Lcom/sec/android/app/sbrowser/global_config/TestFeatureManager;->setUpdatedNotificationCount(Landroid/content/Context;I)V
    ...
    new-instance v1, Lcom/sec/android/app/sbrowser/global_config/TestFeature$1;

    invoke-direct {v1, p0}, Lcom/sec/android/app/sbrowser/global_config/TestFeature$1;-><init>(Lcom/sec/android/app/sbrowser/global_config/TestFeature;)V
