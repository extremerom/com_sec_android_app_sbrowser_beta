.class public Lcom/sec/android/app/sbrowser/common/utils/KeyStoreUtils;
...
.method public static synthetic a()Lcom/sec/android/app/sbrowser/common/utils/KeyStoreUtils;
    .locals 1

    new-instance v0, Lcom/sec/android/app/sbrowser/common/utils/KeyStoreUtils;

    invoke-direct {v0}, Lcom/sec/android/app/sbrowser/common/utils/KeyStoreUtils;-><init>()V

    return-object v0
.end method

.method public static getInstance()Lcom/sec/android/app/sbrowser/common/utils/KeyStoreUtils;
    .locals 2
    ...
    const-class v1, Lcom/sec/android/app/sbrowser/common/utils/KeyStoreUtils;

    invoke-static {v1, v0}, Lcom/sec/android/app/sbrowser/common/singleton/SingletonFactory;->getOrCreate(Ljava/lang/Class;Lcom/sec/android/app/sbrowser/common/function/Supplier;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/sec/android/app/sbrowser/common/utils/KeyStoreUtils;
...
.method private getSecretKey()Ljavax/crypto/SecretKey;
    ...
    invoke-virtual {v3, v0, v2}, Ljava/security/KeyStore;->getEntry(Ljava/lang/String;Ljava/security/KeyStore$ProtectionParameter;)Ljava/security/KeyStore$Entry;
    ...
    :catch_0
    const-string p0, "InvalidAlgorithmParameterException, KeyGenerator init failed"
    ...
    :catch_1
    const-string p0, "NoSuchProviderException, KeyGenerator get failed"
    ...
    :catch_2
    const-string p0, "UnrecoverableEntryException"
    ...
    :catch_3
    const-string p0, "KeyStore load failed"
...
.method public decryptData(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/common/utils/KeyStoreUtils;->getSecretKey()Ljavax/crypto/SecretKey;
    ...
    invoke-virtual {v0, p1, p0, v3}, Ljavax/crypto/Cipher;->init(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    :catch_0
    const-string p0, "decrypt failed"
    ...
    :catch_1
    const-string p0, "Decryption cipher init failed"
    ...
    :catch_2
    const-string p0, "Decryption cipher get failed"
...
.method public decryptData([B)[B
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/sbrowser/common/utils/KeyStoreUtils;->decryptData(Ljava/lang/String;)Ljava/lang/String;
...
.method public encryptData(Ljava/lang/String;)Ljava/lang/String;
    ...
    :catch_2
    const-string p0, "Encryption cipher get failed"
...
.method public encryptData([B)[B
    ...
    invoke-virtual {p0, v0}, Lcom/sec/android/app/sbrowser/common/utils/KeyStoreUtils;->encryptData(Ljava/lang/String;)Ljava/lang/String;
