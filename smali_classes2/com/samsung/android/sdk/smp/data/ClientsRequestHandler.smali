...
.method private buildRequest()Lcom/samsung/android/sdk/smp/data/ClientsRequest;
    ...
    const-string v0, "build request fail. JSONError : "

    const-string v1, "build request fail. "

    invoke-virtual {p0}, Lcom/samsung/android/sdk/smp/data/ClientsRequestHandler;->getContext()Landroid/content/Context;

    move-result-object v2

    invoke-static {v2}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->open(Landroid/content/Context;)Lcom/samsung/android/sdk/smp/common/database/DBHandler;

    move-result-object v2

    const-string v3, "Internal error"

    const-string v4, "SMP_0401"
    ...
    invoke-virtual {p0, v4, v3}, Lcom/samsung/android/sdk/smp/data/ClientsRequestHandler;->afterBuildRequestError(Ljava/lang/String;Ljava/lang/String;)V

    return-object v5

    :cond_0
    :try_start_0
    new-instance v6, Lcom/samsung/android/sdk/smp/data/ClientsRequest$Builder;
    ...
    invoke-direct {v6, v7, v8, v9, v10}, Lcom/samsung/android/sdk/smp/data/ClientsRequest$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lorg/json/JSONObject;)V

    invoke-direct {p0, v2}, Lcom/samsung/android/sdk/smp/data/ClientsRequestHandler;->buildAppFilterData(Lcom/samsung/android/sdk/smp/common/database/DBHandler;)Lorg/json/JSONObject;

    move-result-object v7

    invoke-virtual {v6, v7}, Lcom/samsung/android/sdk/smp/data/ClientsRequest$Builder;->setAppFilterData(Lorg/json/JSONObject;)Lcom/samsung/android/sdk/smp/data/ClientsRequest$Builder;

    move-result-object v6

    invoke-virtual {v2}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->getAppReferrerKeyData()Lorg/json/JSONArray;

    move-result-object v7

    invoke-virtual {v6, v7}, Lcom/samsung/android/sdk/smp/data/ClientsRequest$Builder;->setAppReferrerKeyData(Lorg/json/JSONArray;)Lcom/samsung/android/sdk/smp/data/ClientsRequest$Builder;

    move-result-object v6

    invoke-virtual {v2}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->getAppStartData()Lorg/json/JSONArray;

    move-result-object v7

    invoke-virtual {v6, v7}, Lcom/samsung/android/sdk/smp/data/ClientsRequest$Builder;->setAppStartData(Lorg/json/JSONArray;)Lcom/samsung/android/sdk/smp/data/ClientsRequest$Builder;

    move-result-object v6

    invoke-virtual {v2}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->getSessionData()Lorg/json/JSONArray;

    move-result-object v7

    invoke-virtual {v6, v7}, Lcom/samsung/android/sdk/smp/data/ClientsRequest$Builder;->setSessionData(Lorg/json/JSONArray;)Lcom/samsung/android/sdk/smp/data/ClientsRequest$Builder;

    move-result-object v6

    invoke-direct {p0, v2}, Lcom/samsung/android/sdk/smp/data/ClientsRequestHandler;->buildMarketingData(Lcom/samsung/android/sdk/smp/common/database/DBHandler;)Lorg/json/JSONArray;

    move-result-object v7

    invoke-virtual {v6, v7}, Lcom/samsung/android/sdk/smp/data/ClientsRequest$Builder;->setMarketingData(Lorg/json/JSONArray;)Lcom/samsung/android/sdk/smp/data/ClientsRequest$Builder;
    ...
    invoke-virtual {v6, v7}, Lcom/samsung/android/sdk/smp/data/ClientsRequest$Builder;->setTestData(Lorg/json/JSONObject;)Lcom/samsung/android/sdk/smp/data/ClientsRequest$Builder;

    move-result-object v6

    invoke-virtual {v6}, Lcom/samsung/android/sdk/smp/data/ClientsRequest$Builder;->build()Lcom/samsung/android/sdk/smp/data/ClientsRequest;
    ...
    invoke-virtual {v7}, Lcom/samsung/android/sdk/smp/common/preference/PrefManager;->getActivityTrackingEnabled()Z

    move-result v7

    invoke-virtual {v6, v7}, Lcom/samsung/android/sdk/smp/data/ClientsRequest;->setTrackingEnabled(Z)V
    :try_end_0
    ...
    invoke-static {v3, v1}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->he(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_1
    :try_start_2
    sget-object v6, Lcom/samsung/android/sdk/smp/data/ClientsRequestHandler;->TAG:Ljava/lang/String;
    ...
    invoke-static {v6, v0}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->he(Ljava/lang/String;Ljava/lang/String;)V
...
.method private notifyInitAndUpdateAppFilterForSps(Lcom/samsung/android/sdk/smp/data/ClientsRequest;)Z
    ...
    invoke-virtual {p1, v6}, Lcom/samsung/android/sdk/smp/data/ClientsRequest;->updateAppFilterData(Lorg/json/JSONObject;)V
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Lcom/samsung/android/sdk/smp/common/exception/InternalException$BuildClientsException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
