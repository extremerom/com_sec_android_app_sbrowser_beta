...
.method private applyRandomTimeForDisplay(Ljava/util/Calendar;IIJI)V
    ...
    :cond_2
    invoke-static {v4, v5, p2, p3}, Lcom/samsung/android/sdk/smp/common/util/TimeUtil;->getRandomMillis(JJ)J
    ...
    const-string v2, "random display(s):"
    ...
    invoke-static {p2, p3, p4, p6}, LV0/c;->h(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method private checkFilterInstall(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v0, p1}, Landroidx/recyclerview/widget/P;->D(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method private onGetMarketingStatusFail(Landroid/content/Context;I)V
    ...
    invoke-static {p1, p0, p2, v3}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setToFail(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->getMarketingFailCount(Ljava/lang/String;)I
    ...
    invoke-virtual {v2, v4, v3}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->updateMarketingFailCount(Ljava/lang/String;I)Z
    ...
    sget-object v3, Lcom/samsung/android/sdk/smp/common/constants/MarketingState;->INCOMP_DISPLAY:Lcom/samsung/android/sdk/smp/common/constants/MarketingState;

    invoke-virtual {v2, v0, v3}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->updateMarketingState(Ljava/lang/String;Lcom/samsung/android/sdk/smp/common/constants/MarketingState;)Z

    iget-object v0, p0, Lcom/samsung/android/sdk/smp/marketing/Marketing;->mMid:Ljava/lang/String;

    invoke-virtual {v2, v0, v5}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->updateMarketingFailCount(Ljava/lang/String;I)Z

    iget-object v0, p0, Lcom/samsung/android/sdk/smp/marketing/Marketing;->mMid:Ljava/lang/String;

    sget-object v3, Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;->GET_MARKETING_STATUS_FAIL:Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;
    ...
    invoke-static {p1, v0, v3, p2}, Lcom/samsung/android/sdk/smp/marketing/FeedbackManager;->addFeedback(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v1, v3}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->updateMarketingState(Ljava/lang/String;Lcom/samsung/android/sdk/smp/common/constants/MarketingState;)Z

    iget-object v1, p0, Lcom/samsung/android/sdk/smp/marketing/Marketing;->mMid:Ljava/lang/String;

    invoke-virtual {v2, v1, v5}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->updateMarketingFailCount(Ljava/lang/String;I)Z
    ...
    invoke-static {p1, v0, v1, p2}, Lcom/samsung/android/sdk/smp/marketing/FeedbackManager;->addFeedback(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v3}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->getMarketingStatusRetryDelayTime(I)J
    ...
    invoke-direct {v3, v4, p2, p0}, Lcom/samsung/android/sdk/smp/task/SMarketingTask;-><init>(Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;Landroid/os/Bundle;Ljava/lang/String;)V

    invoke-static {p1, v3, v0, v1, v5}, Lcom/samsung/android/sdk/smp/task/STaskDispatcher;->setDispatchAlarm(Landroid/content/Context;Lcom/samsung/android/sdk/smp/task/STask;JI)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private onResourceDownloadFail(Landroid/content/Context;I)V
    ...
    invoke-static {p1, p0, p2, v2}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setToFail(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v2}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->getMarketingFailCount(Ljava/lang/String;)I
    ...
    invoke-virtual {v1, p2, v2}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->updateMarketingFailCount(Ljava/lang/String;I)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public static setToFail(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;Ljava/lang/String;)V
    ...
    invoke-static {v2}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->canChangeStateToFail(Lcom/samsung/android/sdk/smp/common/constants/MarketingState;)Z
    ...
    invoke-virtual {v1, p1, v0}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->updateMarketingState(Ljava/lang/String;Lcom/samsung/android/sdk/smp/common/constants/MarketingState;)Z
...
.method public setAlarmForScreenOnListener(Landroid/content/Context;)V
    ...
    const-string v5, "listening_start"

    invoke-static {v4, v5}, Lt/b;->e(Ljava/lang/String;Ljava/lang/String;)Landroid/os/Bundle;
