...
.method private static clearMarketingData(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    const-string v0, "fail to clear data. db open fail"
    ...
    :cond_1
    :try_start_0
    invoke-virtual {v2, p1}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->isMarketingExist(Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, p1}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->getMarketingState(Ljava/lang/String;)Lcom/samsung/android/sdk/smp/common/constants/MarketingState;
    ...
    invoke-virtual {v3}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->getMarketingType()Ljava/lang/String;

    move-result-object v3

    invoke-static {v3}, Lcom/samsung/android/sdk/smp/display/DisplayManager;->getDisplayManager(Ljava/lang/String;)Lcom/samsung/android/sdk/smp/display/DisplayManager;

    move-result-object v3

    invoke-virtual {v2, p1}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->getMarketingDisplayId(Ljava/lang/String;)I
    ...
    invoke-virtual {v3, p0, v4}, Lcom/samsung/android/sdk/smp/display/DisplayManager;->clear(Landroid/content/Context;I)Z
    :try_end_1
    ...
    invoke-virtual {v2, p1}, Lcom/samsung/android/sdk/smp/common/database/DBHandler;->deleteMarketingData(Ljava/lang/String;)Z
    ...
    const-string v0, "fail to clear data. invalid params"
...
.method private static doIncompleteRequest(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/common/constants/MarketingState;)V
    ...
    const-string v0, "Incomplete Request. state:"
    ...
    invoke-static {v3, p1, v0}, Lcom/samsung/android/sdk/smp/common/util/SmpLog;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p0}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setAlarmForScreenOnListener(Landroid/content/Context;)V

    invoke-virtual {v0, p0}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setAlarmForGetMarketingStatus(Landroid/content/Context;)V
    ...
    invoke-direct {v0, v1, p2, p1}, Lcom/samsung/android/sdk/smp/task/SMarketingTask;-><init>(Lcom/samsung/android/sdk/smp/task/STask$MarketingAction;Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    invoke-static {p0, v0, v3, v4, p2}, Lcom/samsung/android/sdk/smp/task/STaskDispatcher;->setDispatchAlarm(Landroid/content/Context;Lcom/samsung/android/sdk/smp/task/STask;JI)V
    ...
    invoke-virtual {v0, p0}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setAlarmForDisplay(Landroid/content/Context;)V

    goto :goto_0

    :cond_3
    invoke-virtual {v0}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->getTtlEndMillis()J
    ...
    invoke-virtual {v0, p0}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->clearDisplayedMarketing(Landroid/content/Context;)V
    :try_end_0
    ...
    invoke-static {p0, p1, p2, v2}, Lcom/samsung/android/sdk/smp/marketing/Marketing;->setToFail(Landroid/content/Context;Ljava/lang/String;Lcom/samsung/android/sdk/smp/common/constants/FeedbackEvent;Ljava/lang/String;)V
