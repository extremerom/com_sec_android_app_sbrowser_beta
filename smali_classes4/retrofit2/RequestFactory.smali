...
.method public constructor <init>(Lretrofit2/RequestFactory$Builder;)V
    ...
    iget-object v0, v0, Lretrofit2/Retrofit;->baseUrl:Lhd/A;

    iput-object v0, p0, Lretrofit2/RequestFactory;->baseUrl:Lhd/A;
    ...
    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->headers:Lhd/y;

    iput-object v0, p0, Lretrofit2/RequestFactory;->headers:Lhd/y;

    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->contentType:Lhd/D;

    iput-object v0, p0, Lretrofit2/RequestFactory;->contentType:Lhd/D;
...
# virtual methods
.method public create([Ljava/lang/Object;)Lhd/M;
    .locals 12
    ...
    iget-object v5, p0, Lretrofit2/RequestFactory;->baseUrl:Lhd/A;

    iget-object v6, p0, Lretrofit2/RequestFactory;->relativeUrl:Ljava/lang/String;

    iget-object v7, p0, Lretrofit2/RequestFactory;->headers:Lhd/y;

    iget-object v8, p0, Lretrofit2/RequestFactory;->contentType:Lhd/D;
    ...
    invoke-direct/range {v3 .. v11}, Lretrofit2/RequestBuilder;-><init>(Ljava/lang/String;Lhd/A;Ljava/lang/String;Lhd/y;Lhd/D;ZZZ)V
    ...
    :cond_1
    invoke-virtual {v2}, Lretrofit2/RequestBuilder;->get()Lhd/L;
    ...
    invoke-direct {v0, p0, v3}, Lretrofit2/Invocation;-><init>(Ljava/lang/reflect/Method;Ljava/util/List;)V

    const-class p0, Lretrofit2/Invocation;

    invoke-virtual {p1, p0, v0}, Lhd/L;->e(Ljava/lang/Class;Ljava/lang/Object;)V
    ...
    invoke-static {v1, p1, v2}, Lt/b;->l(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p1, v0, v1}, LB/e;->p(Ljava/lang/StringBuilder;ILjava/lang/String;)Ljava/lang/String;
