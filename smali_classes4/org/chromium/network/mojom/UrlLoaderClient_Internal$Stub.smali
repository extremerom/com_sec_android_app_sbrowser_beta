.class final Lorg/chromium/network/mojom/UrlLoaderClient_Internal$Stub;
...
.method public accept(Lorg/chromium/mojo/bindings/Message;)Z
    ...
    check-cast p0, Lorg/chromium/network/mojom/UrlLoaderClient;
    ...
    invoke-interface {p0, p1}, Lorg/chromium/network/mojom/UrlLoaderClient;->onComplete(Lorg/chromium/network/mojom/UrlLoaderCompletionStatus;)V
    ...
    invoke-interface {p0, p1}, Lorg/chromium/network/mojom/UrlLoaderClient;->onTransferSizeUpdated(I)V
    ...
    iget-object v1, p1, Lorg/chromium/network/mojom/UrlLoaderClient_Internal$UrlLoaderClientOnReceiveRedirectParams;->redirectInfo:Lorg/chromium/network/mojom/UrlRequestRedirectInfo;
    ...
    invoke-interface {p0, v1, p1}, Lorg/chromium/network/mojom/UrlLoaderClient;->onReceiveRedirect(Lorg/chromium/network/mojom/UrlRequestRedirectInfo;Lorg/chromium/network/mojom/UrlResponseHead;)V
    ...
    iget-object v1, p1, Lorg/chromium/network/mojom/UrlLoaderClient_Internal$UrlLoaderClientOnReceiveResponseParams;->head:Lorg/chromium/network/mojom/UrlResponseHead;

    iget-object v2, p1, Lorg/chromium/network/mojom/UrlLoaderClient_Internal$UrlLoaderClientOnReceiveResponseParams;->body:Lorg/chromium/mojo/system/DataPipe$ConsumerHandle;

    iget-object p1, p1, Lorg/chromium/network/mojom/UrlLoaderClient_Internal$UrlLoaderClientOnReceiveResponseParams;->cachedMetadata:Lorg/chromium/mojo_base/mojom/BigBuffer;

    invoke-interface {p0, v1, v2, p1}, Lorg/chromium/network/mojom/UrlLoaderClient;->onReceiveResponse(Lorg/chromium/network/mojom/UrlResponseHead;Lorg/chromium/mojo/system/DataPipe$ConsumerHandle;Lorg/chromium/mojo_base/mojom/BigBuffer;)V
    ...
    invoke-static {p1}, Lorg/chromium/network/mojom/UrlLoaderClient_Internal$UrlLoaderClientOnReceiveEarlyHintsParams;->deserialize(Lorg/chromium/mojo/bindings/Message;)Lorg/chromium/network/mojom/UrlLoaderClient_Internal$UrlLoaderClientOnReceiveEarlyHintsParams;
    ...
    iget-object p1, p1, Lorg/chromium/network/mojom/UrlLoaderClient_Internal$UrlLoaderClientOnReceiveEarlyHintsParams;->earlyHints:Lorg/chromium/network/mojom/EarlyHints;

    invoke-interface {p0, p1}, Lorg/chromium/network/mojom/UrlLoaderClient;->onReceiveEarlyHints(Lorg/chromium/network/mojom/EarlyHints;)V

    return v3

    :cond_7
    sget-object p0, Lorg/chromium/network/mojom/UrlLoaderClient_Internal;->MANAGER:Lorg/chromium/mojo/bindings/Interface$Manager;
...
.method public acceptWithResponder(Lorg/chromium/mojo/bindings/Message;Lorg/chromium/mojo/bindings/MessageReceiver;)Z
    ...
    invoke-direct {v9, p0, p2, v1, v2}, Lorg/chromium/network/mojom/UrlLoaderClient_Internal$UrlLoaderClientOnUploadProgressResponseParamsProxyToResponder;-><init>(Lorg/chromium/mojo/system/Core;Lorg/chromium/mojo/bindings/MessageReceiver;J)V

    invoke-interface/range {v4 .. v9}, Lorg/chromium/network/mojom/UrlLoaderClient;->onUploadProgress(JJLorg/chromium/network/mojom/UrlLoaderClient$OnUploadProgress_Response;)V
