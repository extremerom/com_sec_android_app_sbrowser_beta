.class public final Lorg/chromium/blink/mojom/DevToolsSessionState;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/chromium/blink/mojom/DevToolsSessionState;->VERSION_ARRAY:[Lorg/chromium/mojo/bindings/DataHeader;

    aget-object v0, v0, v2

    sput-object v0, Lorg/chromium/blink/mojom/DevToolsSessionState;->DEFAULT_STRUCT_INFO:Lorg/chromium/mojo/bindings/DataHeader;
...
.method public static decode(Lorg/chromium/mojo/bindings/Decoder;)Lorg/chromium/blink/mojom/DevToolsSessionState;
    .locals 12
    ...
    :try_start_0
    sget-object v0, Lorg/chromium/blink/mojom/DevToolsSessionState;->VERSION_ARRAY:[Lorg/chromium/mojo/bindings/DataHeader;
    ...
    new-instance v1, Lorg/chromium/blink/mojom/DevToolsSessionState;

    invoke-direct {v1, v0}, Lorg/chromium/blink/mojom/DevToolsSessionState;-><init>(I)V
    ...
    invoke-virtual {v3, v10, v11, v5}, Lorg/chromium/mojo/bindings/Decoder;->readBytes(III)[B
    ...
    iput-object v0, v1, Lorg/chromium/blink/mojom/DevToolsSessionState;->entries:Ljava/util/Map;

    :goto_2
    if-ge v2, v7, :cond_3

    iget-object v0, v1, Lorg/chromium/blink/mojom/DevToolsSessionState;->entries:Ljava/util/Map;
...
.method public final encode(Lorg/chromium/mojo/bindings/Encoder;)V
    ...
    sget-object v0, Lorg/chromium/blink/mojom/DevToolsSessionState;->DEFAULT_STRUCT_INFO:Lorg/chromium/mojo/bindings/DataHeader;

    invoke-virtual {p1, v0}, Lorg/chromium/mojo/bindings/Encoder;->getEncoderAtDataOffset(Lorg/chromium/mojo/bindings/DataHeader;)Lorg/chromium/mojo/bindings/Encoder;

    move-result-object p1

    iget-object v0, p0, Lorg/chromium/blink/mojom/DevToolsSessionState;->entries:Ljava/util/Map;
    ...
    iget-object p0, p0, Lorg/chromium/blink/mojom/DevToolsSessionState;->entries:Ljava/util/Map;
    ...
    invoke-virtual {p1, v1, v2, v12, p0}, Lorg/chromium/mojo/bindings/Encoder;->encode([BIII)V
