.class public final Lorg/chromium/blink/mojom/SearchBySessionId;
...
# instance fields
.field public sessionIdMap:Ljava/util/Map;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/chromium/blink/mojom/SearchBySessionId;->VERSION_ARRAY:[Lorg/chromium/mojo/bindings/DataHeader;

    aget-object v0, v0, v2

    sput-object v0, Lorg/chromium/blink/mojom/SearchBySessionId;->DEFAULT_STRUCT_INFO:Lorg/chromium/mojo/bindings/DataHeader;
...
.method public static decode(Lorg/chromium/mojo/bindings/Decoder;)Lorg/chromium/blink/mojom/SearchBySessionId;
    .locals 10
    ...
    :try_start_0
    sget-object v0, Lorg/chromium/blink/mojom/SearchBySessionId;->VERSION_ARRAY:[Lorg/chromium/mojo/bindings/DataHeader;
    ...
    new-instance v1, Lorg/chromium/blink/mojom/SearchBySessionId;

    invoke-direct {v1, v0}, Lorg/chromium/blink/mojom/SearchBySessionId;-><init>(I)V
    ...
    invoke-static {v9}, Lorg/chromium/mojo_base/mojom/UnguessableToken;->decode(Lorg/chromium/mojo/bindings/Decoder;)Lorg/chromium/mojo_base/mojom/UnguessableToken;
    ...
    iput-object v0, v1, Lorg/chromium/blink/mojom/SearchBySessionId;->sessionIdMap:Ljava/util/Map;

    :goto_2
    if-ge v2, v6, :cond_3

    iget-object v0, v1, Lorg/chromium/blink/mojom/SearchBySessionId;->sessionIdMap:Ljava/util/Map;
...
.method public final encode(Lorg/chromium/mojo/bindings/Encoder;)V
    ...
    sget-object v0, Lorg/chromium/blink/mojom/SearchBySessionId;->DEFAULT_STRUCT_INFO:Lorg/chromium/mojo/bindings/DataHeader;

    invoke-virtual {p1, v0}, Lorg/chromium/mojo/bindings/Encoder;->getEncoderAtDataOffset(Lorg/chromium/mojo/bindings/DataHeader;)Lorg/chromium/mojo/bindings/Encoder;

    move-result-object p1

    iget-object v0, p0, Lorg/chromium/blink/mojom/SearchBySessionId;->sessionIdMap:Ljava/util/Map;
    ...
    new-array v11, v0, [Lorg/chromium/mojo_base/mojom/UnguessableToken;

    iget-object p0, p0, Lorg/chromium/blink/mojom/SearchBySessionId;->sessionIdMap:Ljava/util/Map;
    ...
    check-cast v2, Lorg/chromium/mojo_base/mojom/UnguessableToken;
