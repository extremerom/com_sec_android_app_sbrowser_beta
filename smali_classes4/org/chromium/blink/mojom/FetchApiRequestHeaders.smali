.class public final Lorg/chromium/blink/mojom/FetchApiRequestHeaders;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/chromium/blink/mojom/FetchApiRequestHeaders;->VERSION_ARRAY:[Lorg/chromium/mojo/bindings/DataHeader;

    aget-object v0, v0, v2

    sput-object v0, Lorg/chromium/blink/mojom/FetchApiRequestHeaders;->DEFAULT_STRUCT_INFO:Lorg/chromium/mojo/bindings/DataHeader;
...
.method public static decode(Lorg/chromium/mojo/bindings/Decoder;)Lorg/chromium/blink/mojom/FetchApiRequestHeaders;
    .locals 10
    ...
    :try_start_0
    sget-object v0, Lorg/chromium/blink/mojom/FetchApiRequestHeaders;->VERSION_ARRAY:[Lorg/chromium/mojo/bindings/DataHeader;
    ...
    new-instance v1, Lorg/chromium/blink/mojom/FetchApiRequestHeaders;

    invoke-direct {v1, v0}, Lorg/chromium/blink/mojom/FetchApiRequestHeaders;-><init>(I)V
    ...
    invoke-static {v8, v9, v0, v3, v2}, Lcom/sec/android/app/sbrowser/autofill/password/k;->h(IIILorg/chromium/mojo/bindings/Decoder;Z)Ljava/lang/String;
    ...
    iput-object v0, v1, Lorg/chromium/blink/mojom/FetchApiRequestHeaders;->headers:Ljava/util/Map;

    :goto_2
    if-ge v2, v6, :cond_3

    iget-object v0, v1, Lorg/chromium/blink/mojom/FetchApiRequestHeaders;->headers:Ljava/util/Map;
...
.method public final encode(Lorg/chromium/mojo/bindings/Encoder;)V
    ...
    sget-object v0, Lorg/chromium/blink/mojom/FetchApiRequestHeaders;->DEFAULT_STRUCT_INFO:Lorg/chromium/mojo/bindings/DataHeader;

    invoke-virtual {p1, v0}, Lorg/chromium/mojo/bindings/Encoder;->getEncoderAtDataOffset(Lorg/chromium/mojo/bindings/DataHeader;)Lorg/chromium/mojo/bindings/Encoder;

    move-result-object p1

    iget-object v0, p0, Lorg/chromium/blink/mojom/FetchApiRequestHeaders;->headers:Ljava/util/Map;
    ...
    iget-object p0, p0, Lorg/chromium/blink/mojom/FetchApiRequestHeaders;->headers:Ljava/util/Map;
