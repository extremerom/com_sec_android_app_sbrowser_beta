.class public final Lorg/chromium/blink/mojom/LocalResourceLoaderConfig;
...
# instance fields
.field public sources:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Lorg/chromium/url/internal/mojom/Origin;",
            "Lorg/chromium/blink/mojom/LocalResourceSource;",
            ">;"
        }
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/chromium/blink/mojom/LocalResourceLoaderConfig;->VERSION_ARRAY:[Lorg/chromium/mojo/bindings/DataHeader;

    aget-object v0, v0, v2

    sput-object v0, Lorg/chromium/blink/mojom/LocalResourceLoaderConfig;->DEFAULT_STRUCT_INFO:Lorg/chromium/mojo/bindings/DataHeader;
...
.method public static decode(Lorg/chromium/mojo/bindings/Decoder;)Lorg/chromium/blink/mojom/LocalResourceLoaderConfig;
    .locals 10
    ...
    :try_start_0
    sget-object v0, Lorg/chromium/blink/mojom/LocalResourceLoaderConfig;->VERSION_ARRAY:[Lorg/chromium/mojo/bindings/DataHeader;
    ...
    new-instance v1, Lorg/chromium/blink/mojom/LocalResourceLoaderConfig;

    invoke-direct {v1, v0}, Lorg/chromium/blink/mojom/LocalResourceLoaderConfig;-><init>(I)V
    ...
    new-array v5, v5, [Lorg/chromium/blink/mojom/LocalResourceSource;
    ...
    invoke-static {v9}, Lorg/chromium/blink/mojom/LocalResourceSource;->decode(Lorg/chromium/mojo/bindings/Decoder;)Lorg/chromium/blink/mojom/LocalResourceSource;
    ...
    iput-object v0, v1, Lorg/chromium/blink/mojom/LocalResourceLoaderConfig;->sources:Ljava/util/Map;

    :goto_2
    if-ge v2, v6, :cond_3

    iget-object v0, v1, Lorg/chromium/blink/mojom/LocalResourceLoaderConfig;->sources:Ljava/util/Map;
...
.method public final encode(Lorg/chromium/mojo/bindings/Encoder;)V
    ...
    sget-object v0, Lorg/chromium/blink/mojom/LocalResourceLoaderConfig;->DEFAULT_STRUCT_INFO:Lorg/chromium/mojo/bindings/DataHeader;

    invoke-virtual {p1, v0}, Lorg/chromium/mojo/bindings/Encoder;->getEncoderAtDataOffset(Lorg/chromium/mojo/bindings/DataHeader;)Lorg/chromium/mojo/bindings/Encoder;

    move-result-object p1

    iget-object v0, p0, Lorg/chromium/blink/mojom/LocalResourceLoaderConfig;->sources:Ljava/util/Map;
    ...
    new-array v11, v0, [Lorg/chromium/blink/mojom/LocalResourceSource;

    iget-object p0, p0, Lorg/chromium/blink/mojom/LocalResourceLoaderConfig;->sources:Ljava/util/Map;
    ...
    check-cast v2, Lorg/chromium/blink/mojom/LocalResourceSource;
