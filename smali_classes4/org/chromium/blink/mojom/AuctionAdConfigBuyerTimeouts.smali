.class public final Lorg/chromium/blink/mojom/AuctionAdConfigBuyerTimeouts;
...
# instance fields
.field public allBuyersTimeout:Lorg/chromium/mojo_base/mojom/TimeDelta;

.field public perBuyerTimeouts:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Lorg/chromium/url/internal/mojom/Origin;",
            "Lorg/chromium/mojo_base/mojom/TimeDelta;",
            ">;"
        }
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/chromium/blink/mojom/AuctionAdConfigBuyerTimeouts;->VERSION_ARRAY:[Lorg/chromium/mojo/bindings/DataHeader;

    aget-object v0, v0, v2

    sput-object v0, Lorg/chromium/blink/mojom/AuctionAdConfigBuyerTimeouts;->DEFAULT_STRUCT_INFO:Lorg/chromium/mojo/bindings/DataHeader;
...
.method public static decode(Lorg/chromium/mojo/bindings/Decoder;)Lorg/chromium/blink/mojom/AuctionAdConfigBuyerTimeouts;
    .locals 11
    ...
    :try_start_0
    sget-object v1, Lorg/chromium/blink/mojom/AuctionAdConfigBuyerTimeouts;->VERSION_ARRAY:[Lorg/chromium/mojo/bindings/DataHeader;
    ...
    new-instance v2, Lorg/chromium/blink/mojom/AuctionAdConfigBuyerTimeouts;

    invoke-direct {v2, v1}, Lorg/chromium/blink/mojom/AuctionAdConfigBuyerTimeouts;-><init>(I)V
    ...
    iput-object v4, v2, Lorg/chromium/blink/mojom/AuctionAdConfigBuyerTimeouts;->allBuyersTimeout:Lorg/chromium/mojo_base/mojom/TimeDelta;
    ...
    iput-object v0, v2, Lorg/chromium/blink/mojom/AuctionAdConfigBuyerTimeouts;->perBuyerTimeouts:Ljava/util/Map;
    ...
    new-array v5, v5, [Lorg/chromium/mojo_base/mojom/TimeDelta;
    ...
    invoke-static {v9}, Lorg/chromium/mojo_base/mojom/TimeDelta;->decode(Lorg/chromium/mojo/bindings/Decoder;)Lorg/chromium/mojo_base/mojom/TimeDelta;
    ...
    iput-object v1, v2, Lorg/chromium/blink/mojom/AuctionAdConfigBuyerTimeouts;->perBuyerTimeouts:Ljava/util/Map;

    :goto_2
    if-ge v0, v7, :cond_4

    iget-object v1, v2, Lorg/chromium/blink/mojom/AuctionAdConfigBuyerTimeouts;->perBuyerTimeouts:Ljava/util/Map;
...
.method public final encode(Lorg/chromium/mojo/bindings/Encoder;)V
    ...
    sget-object v0, Lorg/chromium/blink/mojom/AuctionAdConfigBuyerTimeouts;->DEFAULT_STRUCT_INFO:Lorg/chromium/mojo/bindings/DataHeader;

    invoke-virtual {p1, v0}, Lorg/chromium/mojo/bindings/Encoder;->getEncoderAtDataOffset(Lorg/chromium/mojo/bindings/DataHeader;)Lorg/chromium/mojo/bindings/Encoder;

    move-result-object p1

    iget-object v0, p0, Lorg/chromium/blink/mojom/AuctionAdConfigBuyerTimeouts;->allBuyersTimeout:Lorg/chromium/mojo_base/mojom/TimeDelta;
    ...
    iget-object v0, p0, Lorg/chromium/blink/mojom/AuctionAdConfigBuyerTimeouts;->perBuyerTimeouts:Ljava/util/Map;
    ...
    new-array v11, v0, [Lorg/chromium/mojo_base/mojom/TimeDelta;

    iget-object p0, p0, Lorg/chromium/blink/mojom/AuctionAdConfigBuyerTimeouts;->perBuyerTimeouts:Ljava/util/Map;
    ...
    check-cast v3, Lorg/chromium/mojo_base/mojom/TimeDelta;
