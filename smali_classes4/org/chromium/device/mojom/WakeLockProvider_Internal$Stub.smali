.class final Lorg/chromium/device/mojom/WakeLockProvider_Internal$Stub;
...
.method public accept(Lorg/chromium/mojo/bindings/Message;)Z
    ...
    check-cast p0, Lorg/chromium/device/mojom/WakeLockProvider;

    iget v1, p1, Lorg/chromium/device/mojom/WakeLockProvider_Internal$WakeLockProviderNotifyOnWakeLockDeactivationParams;->type:I
    ...
    invoke-interface {p0, v1, p1}, Lorg/chromium/device/mojom/WakeLockProvider;->notifyOnWakeLockDeactivation(ILorg/chromium/device/mojom/WakeLockObserver;)V
    ...
    iget v1, p1, Lorg/chromium/device/mojom/WakeLockProvider_Internal$WakeLockProviderGetWakeLockWithoutContextParams;->type:I

    iget v3, p1, Lorg/chromium/device/mojom/WakeLockProvider_Internal$WakeLockProviderGetWakeLockWithoutContextParams;->reason:I

    iget-object v4, p1, Lorg/chromium/device/mojom/WakeLockProvider_Internal$WakeLockProviderGetWakeLockWithoutContextParams;->description:Ljava/lang/String;
    ...
    invoke-interface {p0, v1, v3, v4, p1}, Lorg/chromium/device/mojom/WakeLockProvider;->getWakeLockWithoutContext(IILjava/lang/String;Lorg/chromium/mojo/bindings/InterfaceRequest;)V
    ...
    iget v1, p1, Lorg/chromium/device/mojom/WakeLockProvider_Internal$WakeLockProviderGetWakeLockContextForIdParams;->contextId:I
    ...
    invoke-interface {p0, v1, p1}, Lorg/chromium/device/mojom/WakeLockProvider;->getWakeLockContextForId(ILorg/chromium/mojo/bindings/InterfaceRequest;)V

    return v2

    :cond_5
    sget-object p0, Lorg/chromium/device/mojom/WakeLockProvider_Internal;->MANAGER:Lorg/chromium/mojo/bindings/Interface$Manager;
...
.method public acceptWithResponder(Lorg/chromium/mojo/bindings/Message;Lorg/chromium/mojo/bindings/MessageReceiver;)Z
    ...
    invoke-direct {v4, p0, p2, v5, v6}, Lorg/chromium/device/mojom/WakeLockProvider_Internal$WakeLockProviderGetActiveWakeLocksForTestsResponseParamsProxyToResponder;-><init>(Lorg/chromium/mojo/system/Core;Lorg/chromium/mojo/bindings/MessageReceiver;J)V

    invoke-interface {v2, p1, v4}, Lorg/chromium/device/mojom/WakeLockProvider;->getActiveWakeLocksForTests(ILorg/chromium/device/mojom/WakeLockProvider$GetActiveWakeLocksForTests_Response;)V
