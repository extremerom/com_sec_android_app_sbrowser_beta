.class final Lorg/chromium/device/mojom/HidConnection_Internal$Proxy;
...
# virtual methods
.method public getFeatureReport(BLorg/chromium/device/mojom/HidConnection$GetFeatureReport_Response;)V
    .locals 6
    ...
    new-instance v0, Lorg/chromium/device/mojom/HidConnection_Internal$HidConnectionGetFeatureReportResponseParamsForwardToCallback;

    invoke-direct {v0, p2}, Lorg/chromium/device/mojom/HidConnection_Internal$HidConnectionGetFeatureReportResponseParamsForwardToCallback;-><init>(Lorg/chromium/device/mojom/HidConnection$GetFeatureReport_Response;)V
...
.method public read(Lorg/chromium/device/mojom/HidConnection$Read_Response;)V
    .locals 7
    ...
    new-instance v0, Lorg/chromium/device/mojom/HidConnection_Internal$HidConnectionReadResponseParamsForwardToCallback;

    invoke-direct {v0, p1}, Lorg/chromium/device/mojom/HidConnection_Internal$HidConnectionReadResponseParamsForwardToCallback;-><init>(Lorg/chromium/device/mojom/HidConnection$Read_Response;)V
...
.method public sendFeatureReport(B[BLorg/chromium/device/mojom/HidConnection$SendFeatureReport_Response;)V
    .locals 5
    ...
    new-instance p2, Lorg/chromium/device/mojom/HidConnection_Internal$HidConnectionSendFeatureReportResponseParamsForwardToCallback;

    invoke-direct {p2, p3}, Lorg/chromium/device/mojom/HidConnection_Internal$HidConnectionSendFeatureReportResponseParamsForwardToCallback;-><init>(Lorg/chromium/device/mojom/HidConnection$SendFeatureReport_Response;)V
...
.method public write(B[BLorg/chromium/device/mojom/HidConnection$Write_Response;)V
    .locals 4
    ...
    new-instance p2, Lorg/chromium/device/mojom/HidConnection_Internal$HidConnectionWriteResponseParamsForwardToCallback;

    invoke-direct {p2, p3}, Lorg/chromium/device/mojom/HidConnection_Internal$HidConnectionWriteResponseParamsForwardToCallback;-><init>(Lorg/chromium/device/mojom/HidConnection$Write_Response;)V
