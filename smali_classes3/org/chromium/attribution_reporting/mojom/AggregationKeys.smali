.class public final Lorg/chromium/attribution_reporting/mojom/AggregationKeys;
...
.field public keys:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/String;",
            "Lorg/chromium/mojo_base/mojom/Uint128;",
            ">;"
        }
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/chromium/attribution_reporting/mojom/AggregationKeys;->VERSION_ARRAY:[Lorg/chromium/mojo/bindings/DataHeader;

    aget-object v0, v0, v2

    sput-object v0, Lorg/chromium/attribution_reporting/mojom/AggregationKeys;->DEFAULT_STRUCT_INFO:Lorg/chromium/mojo/bindings/DataHeader;
...
.method public static decode(Lorg/chromium/mojo/bindings/Decoder;)Lorg/chromium/attribution_reporting/mojom/AggregationKeys;
    .locals 10
    ...
    :try_start_0
    sget-object v0, Lorg/chromium/attribution_reporting/mojom/AggregationKeys;->VERSION_ARRAY:[Lorg/chromium/mojo/bindings/DataHeader;
    ...
    new-instance v1, Lorg/chromium/attribution_reporting/mojom/AggregationKeys;

    invoke-direct {v1, v0}, Lorg/chromium/attribution_reporting/mojom/AggregationKeys;-><init>(I)V
    ...
    new-array v5, v5, [Lorg/chromium/mojo_base/mojom/Uint128;
    ...
    invoke-static {v9}, Lorg/chromium/mojo_base/mojom/Uint128;->decode(Lorg/chromium/mojo/bindings/Decoder;)Lorg/chromium/mojo_base/mojom/Uint128;
    ...
    iput-object v0, v1, Lorg/chromium/attribution_reporting/mojom/AggregationKeys;->keys:Ljava/util/Map;

    :goto_2
    if-ge v2, v6, :cond_3

    iget-object v0, v1, Lorg/chromium/attribution_reporting/mojom/AggregationKeys;->keys:Ljava/util/Map;
...
.method public final encode(Lorg/chromium/mojo/bindings/Encoder;)V
    ...
    sget-object v0, Lorg/chromium/attribution_reporting/mojom/AggregationKeys;->DEFAULT_STRUCT_INFO:Lorg/chromium/mojo/bindings/DataHeader;

    invoke-virtual {p1, v0}, Lorg/chromium/mojo/bindings/Encoder;->getEncoderAtDataOffset(Lorg/chromium/mojo/bindings/DataHeader;)Lorg/chromium/mojo/bindings/Encoder;

    move-result-object p1

    iget-object v0, p0, Lorg/chromium/attribution_reporting/mojom/AggregationKeys;->keys:Ljava/util/Map;
    ...
    new-array v11, v0, [Lorg/chromium/mojo_base/mojom/Uint128;

    iget-object p0, p0, Lorg/chromium/attribution_reporting/mojom/AggregationKeys;->keys:Ljava/util/Map;
    ...
    check-cast v2, Lorg/chromium/mojo_base/mojom/Uint128;
