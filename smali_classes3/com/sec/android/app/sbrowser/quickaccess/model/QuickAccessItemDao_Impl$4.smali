.class public final Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessItemDao_Impl$4;
.super LJ2/e;
.source "SourceFile"
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "com/sec/android/app/sbrowser/quickaccess/model/QuickAccessItemDao_Impl$4",
        "LJ2/e;",
...
.method public constructor <init>(Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessItemDao_Impl;)V
    ...
    iput-object p1, p0, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessItemDao_Impl$4;->this$0:Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessItemDao_Impl;
...
.method public bind(LS2/c;Lcom/sec/android/app/sbrowser/quickaccess/model/entity/QuickAccessItemEntity;)V
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessItemDao_Impl$4;->this$0:Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessItemDao_Impl;
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessItemDao_Impl$4;->this$0:Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessItemDao_Impl;
...
.method public bridge synthetic bind(LS2/c;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/sec/android/app/sbrowser/quickaccess/model/QuickAccessItemDao_Impl$4;->bind(LS2/c;Lcom/sec/android/app/sbrowser/quickaccess/model/entity/QuickAccessItemEntity;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string p0, "UPDATE OR IGNORE `quickaccess_item` SET `id` = ?,`title` = ?,`url` = ?,`position` = ?,`touchIcon` = ?,`touchIconUrl` = ?,`dominant` = ?,`type` = ?,`itemId` = ?,`titleState` = ?,`deviceName` = ?,`deviceId` = ?,`dirty` = ?,`deleted` = ?,`accountName` = ?,`accountType` = ?,`sync1` = ?,`sync2` = ?,`sync3` = ?,`sync4` = ?,`sync5` = ? WHERE `id` = ?"
