.class public Lcom/sec/android/app/sbrowser/settings/debug/CountryIsoCodePreferenceFragment;
.super Lw2/A;
.source "SourceFile"
...
.method public static bridge synthetic h(Lcom/sec/android/app/sbrowser/settings/debug/CountryIsoCodePreferenceFragment;)Lcom/sec/android/app/sbrowser/settings/debug/SetOtherValueDialogFragment;
    .locals 0

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/settings/debug/CountryIsoCodePreferenceFragment;->mSetOtherValueDialogFragment:Lcom/sec/android/app/sbrowser/settings/debug/SetOtherValueDialogFragment;

    return-object p0
.end method

.method public static bridge synthetic i(Lcom/sec/android/app/sbrowser/settings/debug/CountryIsoCodePreferenceFragment;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/settings/debug/CountryIsoCodePreferenceFragment;->updateCheckState()V

    return-void
.end method

.method public static bridge synthetic j(Lcom/sec/android/app/sbrowser/settings/debug/CountryIsoCodePreferenceFragment;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/settings/debug/CountryIsoCodePreferenceFragment;->updateSummary()V
...
.method private showSetOtherDialog()V
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/settings/debug/CountryIsoCodePreferenceFragment;->mSetOtherValueDialogFragment:Lcom/sec/android/app/sbrowser/settings/debug/SetOtherValueDialogFragment;

    new-instance v1, Lcom/sec/android/app/sbrowser/settings/debug/CountryIsoCodePreferenceFragment$1;

    invoke-direct {v1, p0}, Lcom/sec/android/app/sbrowser/settings/debug/CountryIsoCodePreferenceFragment$1;-><init>(Lcom/sec/android/app/sbrowser/settings/debug/CountryIsoCodePreferenceFragment;)V
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/settings/debug/CountryIsoCodePreferenceFragment;->mSetOtherValueDialogFragment:Lcom/sec/android/app/sbrowser/settings/debug/SetOtherValueDialogFragment;
...
.method public onPreferenceTreeClick(Landroidx/preference/Preference;)Z
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/settings/debug/CountryIsoCodePreferenceFragment;->showSetOtherDialog()V
