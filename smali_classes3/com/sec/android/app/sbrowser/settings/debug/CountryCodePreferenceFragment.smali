.class public Lcom/sec/android/app/sbrowser/settings/debug/CountryCodePreferenceFragment;
.super Lw2/A;
.source "SourceFile"
...
.method public static bridge synthetic h(Lcom/sec/android/app/sbrowser/settings/debug/CountryCodePreferenceFragment;)Lcom/sec/android/app/sbrowser/settings/debug/SetOtherValueDialogFragment;
    .locals 0

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/settings/debug/CountryCodePreferenceFragment;->mSetOtherValueDialogFragment:Lcom/sec/android/app/sbrowser/settings/debug/SetOtherValueDialogFragment;

    return-object p0
.end method

.method public static bridge synthetic i(Lcom/sec/android/app/sbrowser/settings/debug/CountryCodePreferenceFragment;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/settings/debug/CountryCodePreferenceFragment;->updateCheckState()V

    return-void
.end method

.method public static bridge synthetic j(Lcom/sec/android/app/sbrowser/settings/debug/CountryCodePreferenceFragment;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/settings/debug/CountryCodePreferenceFragment;->updateSummary()V
...
.method private showSetOtherDialog()V
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/settings/debug/CountryCodePreferenceFragment;->mSetOtherValueDialogFragment:Lcom/sec/android/app/sbrowser/settings/debug/SetOtherValueDialogFragment;

    new-instance v1, Lcom/sec/android/app/sbrowser/settings/debug/CountryCodePreferenceFragment$1;

    invoke-direct {v1, p0}, Lcom/sec/android/app/sbrowser/settings/debug/CountryCodePreferenceFragment$1;-><init>(Lcom/sec/android/app/sbrowser/settings/debug/CountryCodePreferenceFragment;)V
    ...
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/settings/debug/CountryCodePreferenceFragment;->mSetOtherValueDialogFragment:Lcom/sec/android/app/sbrowser/settings/debug/SetOtherValueDialogFragment;
...
.method private updateCheckState()V
    ...
    invoke-virtual {v0}, Lcom/sec/android/app/sbrowser/common/device/DebugSettings;->getCountryCode()Ljava/lang/String;
...
.method public onPreferenceTreeClick(Landroidx/preference/Preference;)Z
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/settings/debug/CountryCodePreferenceFragment;->showSetOtherDialog()V
