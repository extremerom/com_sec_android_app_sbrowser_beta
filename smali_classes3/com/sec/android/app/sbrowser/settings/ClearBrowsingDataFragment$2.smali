.class Lcom/sec/android/app/sbrowser/settings/ClearBrowsingDataFragment$2;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/sec/android/app/sbrowser/settings/ClearBrowsingDataFragment;->getTimeRangeArrayAdaptor(I)Landroid/widget/ArrayAdapter;
.end annotation
...
# direct methods
.method public constructor <init>(Lcom/sec/android/app/sbrowser/settings/ClearBrowsingDataFragment;Landroid/content/Context;ILjava/util/List;ZLandroid/graphics/drawable/Drawable;)V
    .locals 0

    iput-object p1, p0, Lcom/sec/android/app/sbrowser/settings/ClearBrowsingDataFragment$2;->this$0:Lcom/sec/android/app/sbrowser/settings/ClearBrowsingDataFragment;

    iput-boolean p5, p0, Lcom/sec/android/app/sbrowser/settings/ClearBrowsingDataFragment$2;->val$isRTL:Z

    iput-object p6, p0, Lcom/sec/android/app/sbrowser/settings/ClearBrowsingDataFragment$2;->val$mCheckDrawable:Landroid/graphics/drawable/Drawable;
...
.method public getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :cond_0
    iget-object v0, p0, Lcom/sec/android/app/sbrowser/settings/ClearBrowsingDataFragment$2;->this$0:Lcom/sec/android/app/sbrowser/settings/ClearBrowsingDataFragment;

    invoke-static {v0}, Lcom/sec/android/app/sbrowser/settings/ClearBrowsingDataFragment;->k(Lcom/sec/android/app/sbrowser/settings/ClearBrowsingDataFragment;)I
    ...
    iget-boolean p1, p0, Lcom/sec/android/app/sbrowser/settings/ClearBrowsingDataFragment$2;->val$isRTL:Z

    if-nez p1, :cond_1

    iget-object p0, p0, Lcom/sec/android/app/sbrowser/settings/ClearBrowsingDataFragment$2;->val$mCheckDrawable:Landroid/graphics/drawable/Drawable;
