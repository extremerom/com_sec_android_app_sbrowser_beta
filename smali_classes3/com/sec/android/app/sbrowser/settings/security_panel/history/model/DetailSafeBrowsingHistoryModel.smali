.class public Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailSafeBrowsingHistoryModel;
...
.method public constructor <init>(Landroid/app/Activity;)V
    ...
    iput-object v0, p0, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailSafeBrowsingHistoryModel;->mScreenID:Ljava/lang/String;
    ...
    iput v1, p0, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailHistoryModel;->mBlockedCount:I

    return-void
.end method

.method public static bridge synthetic a(Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailSafeBrowsingHistoryModel;Ljava/util/concurrent/CopyOnWriteArrayList;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailSafeBrowsingHistoryModel;->attachData(Ljava/util/concurrent/CopyOnWriteArrayList;)V
...
.method private attachData(Ljava/util/concurrent/CopyOnWriteArrayList;)V
    ...
    const-string v2, "DetailSafeBrowsingHistoryModel"
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailSafeBrowsingHistoryModel;->getDescription()Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailSafeBrowsingHistoryModel;->getSummary()Ljava/lang/String;
    ...
    new-instance v2, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailSafeBrowsingHistoryModel$2;

    invoke-direct {v2, v0}, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailSafeBrowsingHistoryModel$2;-><init>(Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailSafeBrowsingHistoryModel;)V
...
.method public deleteItems(Ljava/util/concurrent/CopyOnWriteArrayList;)V
    ...
    const-string v1, "deleteItems delete count : "
    ...
    invoke-super {p0, p1}, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailHistoryModel;->deleteItems(Ljava/util/concurrent/CopyOnWriteArrayList;)V

    new-instance v0, Lcom/sec/terrace/browser/safe_browsing/TerraceSafeBrowsingStatsHelper;

    invoke-direct {v0}, Lcom/sec/terrace/browser/safe_browsing/TerraceSafeBrowsingStatsHelper;-><init>()V
    ...
    check-cast v1, Lcom/sec/android/app/sbrowser/settings/security_panel/history/view/PrivacyHistoryBaseView;

    invoke-virtual {v1}, Lcom/sec/android/app/sbrowser/settings/security_panel/history/view/PrivacyHistoryBaseView;->getUrl()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1}, Lcom/sec/android/app/sbrowser/settings/security_panel/history/view/PrivacyHistoryBaseView;->getTime()J

    move-result-wide v3

    invoke-virtual {v0, v2, v3, v4}, Lcom/sec/terrace/browser/safe_browsing/TerraceSafeBrowsingStatsHelper;->deleteSelected(Ljava/lang/String;J)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailSafeBrowsingHistoryModel;->requestData()V
...
.method public getItemList()Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    const-string v0, "DetailSafeBrowsingHistoryModel"
...
.method public getScreenID()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailSafeBrowsingHistoryModel;->mScreenID:Ljava/lang/String;
...
.method public isBlocked()Z
    ...
    invoke-super {p0}, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailHistoryModel;->isBlocked()Z
...
.method public requestData()V
    ...
    invoke-virtual {v2, v4}, Lcom/sec/android/app/sbrowser/common/utils/DateOnly;->nDaysLater(I)Lcom/sec/android/app/sbrowser/common/utils/DateOnly;
    ...
    const-string v9, "mDateRange[0] start : "

    invoke-direct {v2, v9}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object v9, p0, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailHistoryModel;->mDateRange:[Lcom/sec/android/app/sbrowser/common/utils/DateOnly;

    aget-object v3, v9, v3

    invoke-virtual {v3}, Lcom/sec/android/app/sbrowser/common/utils/DateOnly;->getDisplayString()Ljava/lang/String;
    ...
    const-string v3, "mDateRange[1] end : "

    invoke-direct {v2, v3}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object v3, p0, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailHistoryModel;->mDateRange:[Lcom/sec/android/app/sbrowser/common/utils/DateOnly;
    ...
    new-instance v4, Lcom/sec/terrace/browser/safe_browsing/TerraceSafeBrowsingStatsHelper;

    invoke-direct {v4}, Lcom/sec/terrace/browser/safe_browsing/TerraceSafeBrowsingStatsHelper;-><init>()V

    new-instance v9, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailSafeBrowsingHistoryModel$1;

    invoke-direct {v9, p0, v0}, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailSafeBrowsingHistoryModel$1;-><init>(Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailSafeBrowsingHistoryModel;Ljava/util/concurrent/CopyOnWriteArrayList;)V

    invoke-virtual/range {v4 .. v9}, Lcom/sec/terrace/browser/safe_browsing/TerraceSafeBrowsingStatsHelper;->getSafeBrowsingStats(JJLcom/sec/terrace/browser/safe_browsing/TerraceSafeBrowsingStatsHelper$SafeBrowsingStatsCallback;)V
...
.method public setBlockStatus(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->setSafeBrowsing(Z)V
    ...
    invoke-virtual {v0, v1}, Lcom/sec/android/app/sbrowser/common/device/setting_preference/SettingPreference;->setSafeBrowsingUserOpted(Z)V
...
.method public setScreenID(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/sec/android/app/sbrowser/settings/security_panel/history/model/DetailSafeBrowsingHistoryModel;->mScreenID:Ljava/lang/String;
