.class public Lcom/sec/android/app/sbrowser/toolbar/ToolbarFocus;
...
.method private shouldAddNavigationPadding()Z
    .locals 1
    ...
    invoke-interface {v0}, Lcom/sec/android/app/sbrowser/toolbar/ToolbarDelegate;->isNewQuickAccessPage()Z
    ...
    invoke-interface {v0}, Lcom/sec/android/app/sbrowser/toolbar/ToolbarDelegate;->isMultiTabShowing()Z
...
.method public setToolbarHeight()V
    ...
    invoke-direct {p0}, Lcom/sec/android/app/sbrowser/toolbar/ToolbarFocus;->shouldAddNavigationPadding()Z

    move-result v0

    if-eqz v0, :cond_1

    const-string v0, "si__ToolbarFocus"

    const-string v1, "Add navigation padding"
    ...
    invoke-static {v1}, Lcom/sec/android/app/sbrowser/common/device/DeviceLayoutUtil;->getBottomCutoutHeight(Landroid/content/Context;)I
...
.method public updateOuterLayoutPosition()V
    ...
    invoke-virtual {v1, v3}, Lcom/sec/android/app/sbrowser/common/device/DeviceFeatureUtils;->isBookmarkBarEnabled(Landroid/app/Activity;)Z
...
.method public updateTabBarPosition()V
    ...
    invoke-virtual {v1, v4}, Lcom/sec/android/app/sbrowser/common/device/DeviceFeatureUtils;->isBookmarkBarEnabled(Landroid/app/Activity;)Z
...
.method public updateToolbarLayoutPosition()V
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/toolbar/ToolbarFocus;->updateTransBarPosition()V
    ...
    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/toolbar/ToolbarFocus;->updateTabBarPosition()V

    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/toolbar/ToolbarFocus;->updateOuterLayoutPosition()V

    invoke-virtual {p0}, Lcom/sec/android/app/sbrowser/toolbar/ToolbarFocus;->updateBookmarkBarPosition()V
