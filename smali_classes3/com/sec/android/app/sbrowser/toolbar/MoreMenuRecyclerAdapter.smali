.class abstract Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter$SecondaryMenuItemHolder;
    }
.end annotation
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;Landroid/view/Menu;Lcom/sec/android/app/sbrowser/toolbar/MoreMenuListEventListener;I)V
    ...
    iput-object p3, p0, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;->mMenu:Landroid/view/Menu;
    ...
    iput-object p2, p0, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;->mMenuItems:Ljava/util/List;
    ...
    invoke-virtual {p2, p1, p3}, Lcom/sec/android/app/sbrowser/toolbar/BadgeManager;->getOptionMenuBadgeIdMap(Landroid/app/Activity;Landroid/view/Menu;)Ljava/util/HashMap;

    move-result-object p1

    iput-object p1, p0, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;->mBadgeMap:Ljava/util/HashMap;

    iput-object p4, p0, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;->mListener:Lcom/sec/android/app/sbrowser/toolbar/MoreMenuListEventListener;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;->mIsAdapterAttachedToRecyclerView:Z

    iput p5, p0, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;->mInstanceId:I

    return-void
.end method

.method public static synthetic a(Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;Landroid/view/View;)V
    .locals 0
...
.method public static synthetic b(Landroid/view/View;)V
    ...
    invoke-static {p0}, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;->lambda$onBindViewHolder$3(Landroid/view/View;)V
...
.method public static synthetic d(Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter$SecondaryMenuItemHolder;Landroid/view/View;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;->lambda$onBindViewHolder$0(Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter$SecondaryMenuItemHolder;Landroid/view/View;)V

    return-void
.end method

.method public static bridge synthetic e(Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;)Lcom/sec/android/app/sbrowser/toolbar/MoreMenuListEventListener;
    .locals 0
...
.method private getItemGroupId(I)I
    ...
    iget-object p0, p0, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;->mMenuItems:Ljava/util/List;
...
.method private synthetic lambda$onBindViewHolder$0(Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter$SecondaryMenuItemHolder;Landroid/view/View;)V
    .locals 1
...
.method public getItemViewType(I)I
    ...
    invoke-direct {p0, p1}, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;->getItemMenuId(I)I
...
.method public onBindViewHolder(Landroidx/recyclerview/widget/h1;I)V
    ...
    check-cast p1, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter$SecondaryMenuItemHolder;

    iget-object v0, p1, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter$SecondaryMenuItemHolder;->mContainer:Landroid/widget/RelativeLayout;
    ...
    new-instance v1, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter$1;

    invoke-direct {v1, p0}, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter$1;-><init>(Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;)V

    invoke-virtual {v0, v1}, Landroid/view/View;->setOnLongClickListener(Landroid/view/View$OnLongClickListener;)V

    iget-object v0, p1, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter$SecondaryMenuItemHolder;->mIcon:Landroid/widget/ImageView;

    iget-object v1, p0, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;->mMenuItems:Ljava/util/List;
    ...
    iget-object v0, p1, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter$SecondaryMenuItemHolder;->mText:Landroid/widget/TextView;
    ...
    iget-object v0, p1, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter$SecondaryMenuItemHolder;->mBadge:Landroid/view/View;
    ...
    iget-object v2, p1, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter$SecondaryMenuItemHolder;->mText:Landroid/widget/TextView;

    invoke-static {v2, v1, v5}, Lcom/sec/android/app/sbrowser/autofill/password/k;->u(Landroid/widget/TextView;Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    iget-object v1, p1, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter$SecondaryMenuItemHolder;->mText:Landroid/widget/TextView;
    ...
    iget-object v0, p1, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter$SecondaryMenuItemHolder;->mBlockedCounts:Landroid/widget/TextView;

    invoke-direct {p0, v0}, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;->updateContentsBlockedCount(Landroid/widget/TextView;)V
    ...
    iget-object v1, p1, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter$SecondaryMenuItemHolder;->mIcon:Landroid/widget/ImageView;
    ...
    iget-object v3, p0, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;->mContext:Landroid/content/Context;
    ...
    :cond_7
    iget-object v3, p1, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter$SecondaryMenuItemHolder;->mText:Landroid/widget/TextView;
    ...
    :goto_2
    iget-object v1, p1, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter$SecondaryMenuItemHolder;->mContainer:Landroid/widget/RelativeLayout;

    iget-object v3, p0, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;->mMenuItems:Ljava/util/List;
    ...
    invoke-static {v1, v3}, Lcom/sec/android/app/sbrowser/common/utils/ViewUtil;->setEnabledWithAlpha(Landroid/view/View;Z)V
    ...
    new-instance v2, Lcom/sec/android/app/sbrowser/toolbar/v;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, Lcom/sec/android/app/sbrowser/toolbar/v;-><init>(Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;I)V
    ...
    invoke-direct {v2, v3}, Lcom/sec/android/app/sbrowser/toolbar/r;-><init>(I)V
    ...
    iget-object v2, p0, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter;->mMenuItems:Ljava/util/List;
    ...
    invoke-static {v2, v3, v1}, Lcom/sec/android/app/sbrowser/common/extensions/SixUtil;->getActionStatus(ZLandroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {v1, v6}, Lcom/sec/android/app/sbrowser/common/utils/ViewUtil;->setEnabledWithAlpha(Landroid/view/View;Z)V
    ...
    invoke-virtual {v1}, Lcom/sec/android/app/sbrowser/common/customize_toolbar/ToolbarExtensionsManager;->isSupportMainSwitch()Z
    ...
    invoke-virtual {v1}, Lcom/sec/android/app/sbrowser/common/customize_toolbar/ToolbarExtensionsManager;->getTransResourceId()I
    ...
    invoke-static {v1, v4}, Lcom/sec/android/app/sbrowser/common/utils/ViewUtil;->setEnabledWithAlpha(Landroid/view/View;Z)V
    ...
    iget-object p2, p1, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter$SecondaryMenuItemHolder;->mTabCountView:Landroid/widget/TextView;
    ...
    iget-object p0, p1, Lcom/sec/android/app/sbrowser/toolbar/MoreMenuRecyclerAdapter$SecondaryMenuItemHolder;->mTabCountView:Landroid/widget/TextView;
