...
# static fields
.field public static final g:Lcc/h;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcc/h;->h:Lcc/a;

    new-instance v0, Lcc/h;

    invoke-direct {v0}, Lcc/h;-><init>()V

    sput-object v0, Lcc/h;->g:Lcc/h;

    const/4 v1, 0x0

    iput v1, v0, Lcc/h;->c:I

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Lcc/h;->d:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-byte v0, p0, Lcc/h;->e:B

    iput v0, p0, Lcc/h;->f:I

    sget-object v0, Lic/e;->a:Lic/w;

    iput-object v0, p0, Lcc/h;->a:Lic/e;
...
.method public constructor <init>(Lcc/g;)V
    ...
    iput-object p1, p0, Lcc/h;->a:Lic/e;
...
.method public constructor <init>(Lcom/google/crypto/tink/shaded/protobuf/i;Lic/g;)V
    ...
    iput v0, p0, Lcc/h;->c:I

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, p0, Lcc/h;->d:Ljava/util/List;
    ...
    invoke-virtual {p1, v6, v3}, Lcom/google/crypto/tink/shaded/protobuf/i;->v(ILK6/q;)Z
    ...
    iput-object v6, p0, Lcc/h;->d:Ljava/util/List;
    ...
    :cond_3
    :goto_1
    iget-object v6, p0, Lcc/h;->d:Ljava/util/List;

    sget-object v7, Lcc/f;->h:Lcc/a;
    ...
    iget-object p2, p0, Lcc/h;->d:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lcc/h;->d:Ljava/util/List;
    ...
    iput-object p2, p0, Lcc/h;->a:Lic/e;
    ...
    iget-object p1, p0, Lcc/h;->d:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lcc/h;->d:Ljava/util/List;
...
.method public final a()I
    ...
    :goto_0
    iget-object v1, p0, Lcc/h;->d:Ljava/util/List;
    ...
    :cond_2
    iget-object v1, p0, Lcc/h;->a:Lic/e;
...
.method public final b()Lic/k;
    ...
    invoke-direct {p0, v0}, Lcc/g;-><init>(I)V
...
.method public final d(LK6/q;)V
    ...
    :cond_1
    iget-object p0, p0, Lcc/h;->a:Lic/e;
...
.method public final isInitialized()Z
    ...
    :goto_0
    iget-object v3, p0, Lcc/h;->d:Ljava/util/List;
    ...
    invoke-virtual {v3}, Lcc/f;->isInitialized()Z

    move-result v3

    if-nez v3, :cond_2

    iput-byte v2, p0, Lcc/h;->e:B
