...
.field public static final i:LNc/F;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LNc/F;->i:LNc/F;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, LNc/Y;->V(Z)V
...
.method public final T()Ljava/lang/Thread;
    ...
    sget-object v0, LNc/F;->_thread:Ljava/lang/Thread;
    ...
    sput-object v0, LNc/F;->_thread:Ljava/lang/Thread;
...
.method public final k(JLjava/lang/Runnable;Lib/h;)LNc/P;
    ...
    new-instance p4, LNc/U;

    add-long/2addr v0, p1

    invoke-direct {p4, p3, v0, v1}, LNc/U;-><init>(Ljava/lang/Runnable;J)V

    invoke-virtual {p0, p1, p2, p4}, LNc/X;->v0(JLNc/V;)V

    goto :goto_1

    :cond_2
    sget-object p4, LNc/z0;->a:LNc/z0;

    :goto_1
    return-object p4
.end method

.method public final k0(JLNc/V;)V
    .locals 0
...
.method public final m0(Ljava/lang/Runnable;)V
    ...
    sget v0, LNc/F;->debugStatus:I

    const/4 v1, 0x4

    if-eq v0, v1, :cond_0

    invoke-super {p0, p1}, LNc/X;->m0(Ljava/lang/Runnable;)V
...
.method public final run()V
    ...
    sput-object v2, LNc/F;->_thread:Ljava/lang/Thread;

    invoke-virtual/range {p0 .. p0}, LNc/F;->z0()V

    invoke-virtual/range {p0 .. p0}, LNc/X;->s0()Z

    move-result v0

    if-nez v0, :cond_2

    invoke-virtual/range {p0 .. p0}, LNc/F;->T()Ljava/lang/Thread;
    ...
    invoke-virtual/range {p0 .. p0}, LNc/X;->b0()J
...
.method public final shutdown()V
    ...
    sput v0, LNc/F;->debugStatus:I

    invoke-super {p0}, LNc/X;->shutdown()V
