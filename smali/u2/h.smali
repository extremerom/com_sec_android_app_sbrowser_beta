...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput p1, p0, Lu2/h;->a:F

    iput p1, p0, Lu2/h;->b:F

    iput p1, p0, Lu2/h;->c:F

    new-instance p1, Landroid/text/TextPaint;

    invoke-direct {p1}, Landroid/text/TextPaint;-><init>()V

    iput-object p1, p0, Lu2/h;->f:Landroid/text/TextPaint;
    ...
    iput-object p1, p0, Lu2/h;->g:Landroid/graphics/Paint;
...
.method public final a(Landroid/graphics/Canvas;Z)V
    ...
    iget-object p2, p0, Lu2/h;->C:Landroid/text/StaticLayout;

    iget-object v0, p0, Lu2/h;->D:Landroid/text/StaticLayout;
    ...
    iget v2, p0, Lu2/h;->E:I

    int-to-float v2, v2

    iget v3, p0, Lu2/h;->F:I

    int-to-float v3, v3

    invoke-virtual {p1, v2, v3}, Landroid/graphics/Canvas;->translate(FF)V

    iget v2, p0, Lu2/h;->s:I
    ...
    iget-object v8, p0, Lu2/h;->g:Landroid/graphics/Paint;

    iget v2, p0, Lu2/h;->s:I

    invoke-virtual {v8, v2}, Landroid/graphics/Paint;->setColor(I)V

    iget v2, p0, Lu2/h;->G:I
    ...
    :cond_1
    iget v2, p0, Lu2/h;->u:I

    iget-object v3, p0, Lu2/h;->f:Landroid/text/TextPaint;
    ...
    iget v2, p0, Lu2/h;->a:F

    invoke-virtual {v3, v2}, Landroid/graphics/Paint;->setStrokeWidth(F)V

    iget v2, p0, Lu2/h;->t:I
    ...
    iget v7, p0, Lu2/h;->b:F

    if-ne v2, v6, :cond_3

    iget v0, p0, Lu2/h;->c:F
