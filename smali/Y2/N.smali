...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, LY2/N;->a:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, LY2/N;->b:Landroid/graphics/Matrix;

    sget-object v0, LY2/V;->j:[I
    ...
    invoke-static {p1, p2, v0, v1}, LW0/b;->e(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)Ljava/lang/String;

    move-result-object p2

    if-eqz p2, :cond_0

    invoke-static {p2}, LG5/p3;->c(Ljava/lang/String;)Landroid/graphics/Path;

    move-result-object p2

    invoke-virtual {p0, p2}, LY2/N;->b(Landroid/graphics/Path;)V
    :try_end_0
...
.method public final a(FFFF)Landroid/graphics/Path;
    ...
    iget-object p0, p0, LY2/N;->a:Landroid/graphics/Path;
...
.method public final b(Landroid/graphics/Path;)V
    ...
    iget-object v5, p0, LY2/N;->b:Landroid/graphics/Matrix;
