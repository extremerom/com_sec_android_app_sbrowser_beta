...
.method public constructor <init>(Lcom/google/android/material/textfield/TextInputLayout;LZ3/x;)V
    ...
    iput-object p1, p0, Lcom/google/android/material/textfield/b;->a:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    iput-object v1, p0, Lcom/google/android/material/textfield/b;->d:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    iput-object v4, p0, Lcom/google/android/material/textfield/b;->b:Landroidx/appcompat/widget/AppCompatTextView;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v5

    invoke-static {v5}, LG5/v;->i(Landroid/content/Context;)Z
    ...
    :cond_0
    iget-object v5, p0, Lcom/google/android/material/textfield/b;->i:Landroid/view/View$OnLongClickListener;

    invoke-virtual {v1, v6}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-static {v1, v5}, LG5/T3;->e(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V

    iput-object v6, p0, Lcom/google/android/material/textfield/b;->i:Landroid/view/View$OnLongClickListener;

    invoke-virtual {v1, v6}, Landroid/view/View;->setOnLongClickListener(Landroid/view/View$OnLongClickListener;)V

    invoke-static {v1, v6}, LG5/T3;->e(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V

    iget-object v5, p2, LZ3/x;->c:Ljava/lang/Object;
    ...
    invoke-static {v8, p2, v7}, LG5/v;->f(Landroid/content/Context;LZ3/x;I)Landroid/content/res/ColorStateList;

    move-result-object v7

    iput-object v7, p0, Lcom/google/android/material/textfield/b;->e:Landroid/content/res/ColorStateList;
    ...
    invoke-static {v7, v6}, Ls6/l;->k(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v7

    iput-object v7, p0, Lcom/google/android/material/textfield/b;->f:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {p2, v7}, LZ3/x;->w(I)Landroid/graphics/drawable/Drawable;

    move-result-object v7

    invoke-virtual {p0, v7}, Lcom/google/android/material/textfield/b;->b(Landroid/graphics/drawable/Drawable;)V
    ...
    iget v8, p0, Lcom/google/android/material/textfield/b;->g:I

    if-eq v7, v8, :cond_5

    iput v7, p0, Lcom/google/android/material/textfield/b;->g:I
    ...
    invoke-static {v3}, LG5/T3;->b(I)Landroid/widget/ImageView$ScaleType;

    move-result-object v3

    iput-object v3, p0, Lcom/google/android/material/textfield/b;->h:Landroid/widget/ImageView$ScaleType;
    ...
    invoke-virtual {p2, p1}, LZ3/x;->v(I)Landroid/content/res/ColorStateList;
    ...
    :goto_0
    iput-object v6, p0, Lcom/google/android/material/textfield/b;->c:Ljava/lang/CharSequence;
...
.method public final b(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object p1, p0, Lcom/google/android/material/textfield/b;->e:Landroid/content/res/ColorStateList;

    iget-object v1, p0, Lcom/google/android/material/textfield/b;->f:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object p0, p0, Lcom/google/android/material/textfield/b;->e:Landroid/content/res/ColorStateList;
    ...
    iget-object p1, p0, Lcom/google/android/material/textfield/b;->i:Landroid/view/View$OnLongClickListener;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-static {v0, p1}, LG5/T3;->e(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V

    iput-object v1, p0, Lcom/google/android/material/textfield/b;->i:Landroid/view/View$OnLongClickListener;

    invoke-virtual {v0, v1}, Landroid/view/View;->setOnLongClickListener(Landroid/view/View$OnLongClickListener;)V

    invoke-static {v0, v1}, LG5/T3;->e(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V
...
.method public final d()V
    ...
    :cond_0
    iget-object v1, p0, Lcom/google/android/material/textfield/b;->d:Lcom/google/android/material/internal/CheckableImageButton;
...
.method public final e()V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/b;->c:Ljava/lang/CharSequence;
    ...
    :goto_0
    iget-object v3, p0, Lcom/google/android/material/textfield/b;->d:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    iget-object v1, p0, Lcom/google/android/material/textfield/b;->b:Landroidx/appcompat/widget/AppCompatTextView;
