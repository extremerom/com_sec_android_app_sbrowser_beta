...
.method public static build()Lcom/google/cardboard/proto/CardboardDevice$DeviceParams;
    ...
    const-string v2, "Cardboard v1"

    invoke-virtual {v1, v2}, Lcom/google/cardboard/proto/CardboardDevice$DeviceParams$Builder;->setModel(Ljava/lang/String;)Lcom/google/cardboard/proto/CardboardDevice$DeviceParams$Builder;

    move-result-object v1

    sget-object v2, Lcom/google/cardboard/sdk/deviceparams/CardboardV1DeviceParams;->CARDBOARD_V1_PRIMARY_BUTTON_TYPE:Lcom/google/cardboard/proto/CardboardDevice$DeviceParams$ButtonType;

    invoke-virtual {v1, v2}, Lcom/google/cardboard/proto/CardboardDevice$DeviceParams$Builder;->setPrimaryButton(Lcom/google/cardboard/proto/CardboardDevice$DeviceParams$ButtonType;)Lcom/google/cardboard/proto/CardboardDevice$DeviceParams$Builder;

    move-result-object v1

    const v2, 0x3d2c0831    # 0.042f

    invoke-virtual {v1, v2}, Lcom/google/cardboard/proto/CardboardDevice$DeviceParams$Builder;->setScreenToLensDistance(F)Lcom/google/cardboard/proto/CardboardDevice$DeviceParams$Builder;

    move-result-object v1

    const v2, 0x3d75c28f    # 0.06f

    invoke-virtual {v1, v2}, Lcom/google/cardboard/proto/CardboardDevice$DeviceParams$Builder;->setInterLensDistance(F)Lcom/google/cardboard/proto/CardboardDevice$DeviceParams$Builder;

    move-result-object v1

    sget-object v2, Lcom/google/cardboard/sdk/deviceparams/CardboardV1DeviceParams;->CARDBOARD_V1_VERTICAL_ALIGNMENT_TYPE:Lcom/google/cardboard/proto/CardboardDevice$DeviceParams$VerticalAlignmentType;

    invoke-virtual {v1, v2}, Lcom/google/cardboard/proto/CardboardDevice$DeviceParams$Builder;->setVerticalAlignment(Lcom/google/cardboard/proto/CardboardDevice$DeviceParams$VerticalAlignmentType;)Lcom/google/cardboard/proto/CardboardDevice$DeviceParams$Builder;

    move-result-object v1

    const v2, 0x3d0f5c29    # 0.035f

    invoke-virtual {v1, v2}, Lcom/google/cardboard/proto/CardboardDevice$DeviceParams$Builder;->setTrayToLensDistance(F)Lcom/google/cardboard/proto/CardboardDevice$DeviceParams$Builder;
