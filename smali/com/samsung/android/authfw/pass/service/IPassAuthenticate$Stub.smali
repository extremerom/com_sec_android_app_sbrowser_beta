...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-static {p2, p1}, Lcom/samsung/android/authfw/pass/service/IPassAuthenticate$_Parcel;->access$000(Landroid/os/Parcel;Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroid/content/Intent;

    invoke-interface {p0, p1}, Lcom/samsung/android/authfw/pass/service/IPassAuthenticate;->request(Landroid/content/Intent;)Landroid/content/Intent;

    move-result-object p0

    invoke-virtual {p3}, Landroid/os/Parcel;->writeNoException()V

    invoke-static {p3, p0, v1}, Lcom/samsung/android/authfw/pass/service/IPassAuthenticate$_Parcel;->access$100(Landroid/os/Parcel;Landroid/os/Parcelable;I)V
    ...
    invoke-static {p2}, Lcom/samsung/android/authfw/pass/service/IPassAuthenticateCallback$Stub;->asInterface(Landroid/os/IBinder;)Lcom/samsung/android/authfw/pass/service/IPassAuthenticateCallback;

    move-result-object p2

    invoke-interface {p0, p1, p2}, Lcom/samsung/android/authfw/pass/service/IPassAuthenticate;->samsungPassRequest(Landroid/content/Intent;Lcom/samsung/android/authfw/pass/service/IPassAuthenticateCallback;)Z
    ...
    :cond_4
    invoke-interface {p0}, Lcom/samsung/android/authfw/pass/service/IPassAuthenticate;->getVersion()I
