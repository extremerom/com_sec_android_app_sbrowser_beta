...
.method public synthetic constructor <init>(Lcom/samsung/android/camera/sdk/iris/SIrisManager;Landroid/content/Context;Lcom/samsung/android/camera/sdk/iris/SIrisManager$1;)V
    .locals 0
...
.method public synthetic constructor <init>(Lcom/samsung/android/camera/sdk/iris/SIrisManager;Landroid/os/Looper;Lcom/samsung/android/camera/sdk/iris/SIrisManager$1;)V
    .locals 0
...
.method private sendAcquiredResult(JI)V
    ...
    :cond_0
    iget-object p0, p0, Lcom/samsung/android/camera/sdk/iris/SIrisManager$MyHandler;->this$0:Lcom/samsung/android/camera/sdk/iris/SIrisManager;

    invoke-static {p0}, Lcom/samsung/android/camera/sdk/iris/SIrisManager;->access$300(Lcom/samsung/android/camera/sdk/iris/SIrisManager;)Lcom/samsung/android/camera/sdk/iris/SIrisManager$AuthenticationCallback;

    move-result-object p0

    invoke-virtual {p0, p3, p1}, Lcom/samsung/android/camera/sdk/iris/SIrisManager$AuthenticationCallback;->onAuthenticationHelp(ILjava/lang/CharSequence;)V
...
.method private sendAuthenticatedFailed()V
    ...
    invoke-virtual {p0}, Lcom/samsung/android/camera/sdk/iris/SIrisManager$AuthenticationCallback;->onAuthenticationFailed()V
...
.method private sendAuthenticatedSucceeded(Lcom/samsung/android/camera/iris/Iris;)V
    ...
    invoke-virtual {p0, v0}, Lcom/samsung/android/camera/sdk/iris/SIrisManager$AuthenticationCallback;->onAuthenticationSucceeded(Lcom/samsung/android/camera/sdk/iris/SIrisManager$AuthenticationResult;)V
...
.method private sendAuthenticatedSucceededFidoResultData([B)V
    ...
    invoke-static {p0}, Lcom/samsung/android/camera/sdk/iris/SIrisManager;->access$600(Lcom/samsung/android/camera/sdk/iris/SIrisManager;)Lcom/samsung/android/camera/sdk/iris/SIrisManager$CryptoObject;

    move-result-object p0

    invoke-static {p0, p1}, Lcom/samsung/android/camera/sdk/iris/SIrisManager$CryptoObject;->access$700(Lcom/samsung/android/camera/sdk/iris/SIrisManager$CryptoObject;[B)V
...
.method private sendErrorResult(JI)V
    ...
    const-string p1, "sendErrorResult, errMsgId : "

    const-string p2, "SIrisManager"

    invoke-static {p3, p1, p2}, LV0/c;->y(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, p3}, Lcom/samsung/android/camera/sdk/iris/SIrisManager;->access$500(Lcom/samsung/android/camera/sdk/iris/SIrisManager;I)Ljava/lang/String;

    move-result-object p0

    invoke-virtual {p1, p3, p0}, Lcom/samsung/android/camera/sdk/iris/SIrisManager$AuthenticationCallback;->onAuthenticationError(ILjava/lang/CharSequence;)V
...
.method private sendIRImage([BII)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/samsung/android/camera/sdk/iris/SIrisManager$AuthenticationCallback;->onIRImage([BII)V
