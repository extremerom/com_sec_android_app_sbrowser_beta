...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lc1/b;->b:LB0/r;

    return-void
.end method

.method public static a(Landroid/content/Context;Ljava/util/List;Landroid/os/CancellationSignal;)Lc1/h;
    .locals 5
    ...
    invoke-static {v3, v2, v4}, Lc1/b;->b(Landroid/content/pm/PackageManager;Lc1/c;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    ...
    invoke-static {p0, v2, v3, p2}, Lc1/b;->c(Landroid/content/Context;Lc1/c;Ljava/lang/String;Landroid/os/CancellationSignal;)[Lc1/i;
    ...
    invoke-direct {p0, v0}, Lc1/h;-><init>(Ljava/util/ArrayList;)V
    :try_end_1
...
.method public static b(Landroid/content/pm/PackageManager;Lc1/c;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    .locals 9
    ...
    invoke-static {v2}, LG5/t3;->a(Ljava/lang/String;)V

    :try_start_0
    iget-object v2, p1, Lc1/c;->d:Ljava/util/List;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v3, p1, Lc1/c;->a:Ljava/lang/String;

    iget-object v4, p1, Lc1/c;->b:Ljava/lang/String;
    ...
    :cond_0
    :try_start_1
    iget p1, p1, Lc1/c;->e:I

    invoke-static {p2, p1}, LW0/b;->m(Landroid/content/res/Resources;I)Ljava/util/List;
    ...
    iput-object v3, p1, Lc1/a;->a:Ljava/lang/String;

    iput-object v4, p1, Lc1/a;->b:Ljava/lang/String;

    iput-object v2, p1, Lc1/a;->c:Ljava/util/List;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    sget-object p2, Lc1/b;->a:LN/m;

    :try_start_2
    invoke-virtual {p2, p1}, LN/m;->f(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_5
    invoke-virtual {p2, p1, v6}, LN/m;->j(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_4
...
.method public static c(Landroid/content/Context;Lc1/c;Ljava/lang/String;Landroid/os/CancellationSignal;)[Lc1/i;
    .locals 20
    ...
    iget-object v0, v0, Lc1/c;->c:Ljava/lang/String;
    ...
    invoke-direct/range {v14 .. v19}, Lc1/i;-><init>(Landroid/net/Uri;IIZI)V
