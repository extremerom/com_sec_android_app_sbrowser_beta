...
# direct methods
.method public constructor <init>(LK6/x;Landroid/content/Context;I[Ljava/lang/String;)V
    .locals 0

    iput-object p1, p0, LK6/w;->c:LK6/x;
...
.method public final a()V
    ...
    iget-object v0, p0, LK6/w;->c:LK6/x;

    iget-object v1, v0, LK6/x;->k:Landroid/content/res/ColorStateList;
    ...
    :goto_1
    iput-object v5, p0, LK6/w;->b:Landroid/content/res/ColorStateList;

    iget v1, v0, LK6/x;->j:I
    ...
    iget-object v4, v0, LK6/x;->k:Landroid/content/res/ColorStateList;

    invoke-virtual {v4, v3, v2}, Landroid/content/res/ColorStateList;->getColorForState([II)I

    move-result v4

    iget-object v5, v0, LK6/x;->k:Landroid/content/res/ColorStateList;

    invoke-virtual {v5, v1, v2}, Landroid/content/res/ColorStateList;->getColorForState([II)I

    move-result v5

    iget v6, v0, LK6/x;->j:I

    invoke-static {v4, v6}, LX0/a;->c(II)I

    move-result v4

    iget v6, v0, LK6/x;->j:I

    invoke-static {v5, v6}, LX0/a;->c(II)I

    move-result v5

    iget v0, v0, LK6/x;->j:I
    ...
    :cond_2
    iput-object v4, p0, LK6/w;->a:Landroid/content/res/ColorStateList;
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object p3, p0, LK6/w;->c:LK6/x;
    ...
    iget v0, p3, LK6/x;->j:I

    if-eqz v0, :cond_1

    new-instance v0, Landroid/graphics/drawable/ColorDrawable;

    iget p3, p3, LK6/x;->j:I

    invoke-direct {v0, p3}, Landroid/graphics/drawable/ColorDrawable;-><init>(I)V

    iget-object p3, p0, LK6/w;->b:Landroid/content/res/ColorStateList;

    if-eqz p3, :cond_0

    iget-object p3, p0, LK6/w;->a:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, p3}, Landroid/graphics/drawable/Drawable;->setTintList(Landroid/content/res/ColorStateList;)V

    new-instance p3, Landroid/graphics/drawable/RippleDrawable;

    iget-object p0, p0, LK6/w;->b:Landroid/content/res/ColorStateList;
