...
.field private mForwardingListener:Lt/j0;

.field mListPopupWindow:Lt/q0;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v1, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mDropDownGravity:I

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v2

    invoke-static {v2, p0}, Lt/d1;->a(Landroid/content/Context;Landroid/view/View;)V

    sget-object v2, Lk/a;->x:[I

    invoke-static {p1, p2, v2, v0}, LZ3/x;->C(Landroid/content/Context;Landroid/util/AttributeSet;[II)LZ3/x;

    move-result-object v3

    new-instance v4, Lt/r;

    invoke-direct {v4, p0}, Lt/r;-><init>(Landroid/view/View;)V

    iput-object v4, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mBackgroundTintHelper:Lt/r;

    iget-object v4, v3, LZ3/x;->c:Ljava/lang/Object;
    ...
    invoke-direct {v6, p1, v5}, Lr/d;-><init>(Landroid/content/Context;I)V
    ...
    invoke-direct {v5, p0, v9, p2}, Landroidx/appcompat/widget/c;-><init>(Landroidx/appcompat/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;)V

    iget-object v9, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopupContext:Landroid/content/Context;

    invoke-static {v9, p2, v2, v0}, LZ3/x;->C(Landroid/content/Context;Landroid/util/AttributeSet;[II)LZ3/x;
    ...
    iget-object v11, v2, LZ3/x;->c:Ljava/lang/Object;
    ...
    invoke-virtual {v5}, Lt/q0;->getHorizontalOffset()I

    move-result v9

    iput v9, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mDropDownHorizontalOffset:I

    invoke-virtual {v4, v7}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object v7

    iput-object v7, v5, Landroidx/appcompat/widget/c;->a:Ljava/lang/CharSequence;

    invoke-virtual {v2}, LZ3/x;->F()V

    iput-object v5, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopup:Lt/L;

    iput-object v5, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mListPopupWindow:Lt/q0;

    new-instance v2, Lt/G;

    invoke-direct {v2, p0, p0, v5}, Lt/G;-><init>(Landroidx/appcompat/widget/AppCompatSpinner;Landroidx/appcompat/widget/AppCompatSpinner;Landroidx/appcompat/widget/c;)V

    iput-object v2, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mForwardingListener:Lt/j0;
    ...
    invoke-direct {v2, p0}, Lt/H;-><init>(Landroidx/appcompat/widget/AppCompatSpinner;)V

    iput-object v2, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopup:Lt/L;

    invoke-virtual {v4, v7}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object v5

    iput-object v5, v2, Lt/H;->c:Ljava/lang/CharSequence;
    ...
    :cond_6
    iget-object p0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mBackgroundTintHelper:Lt/r;

    invoke-virtual {p0, p2, v0}, Lt/r;->d(Landroid/util/AttributeSet;I)V
...
.method public getDropDownHorizontalOffset()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopup:Lt/L;

    if-eqz v0, :cond_0

    invoke-interface {v0}, Lt/L;->getHorizontalOffset()I
...
.method public getDropDownVerticalOffset()I
    ...
    invoke-interface {v0}, Lt/L;->getVerticalOffset()I
...
.method public final getInternalPopup()Lt/L;
    .locals 0
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation

    iget-object p0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopup:Lt/L;
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Lt/L;->getBackground()Landroid/graphics/drawable/Drawable;
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Lt/L;->a()Ljava/lang/CharSequence;
...
.method public onDetachedFromWindow()V
    ...
    invoke-interface {v0}, Lt/L;->dismiss()V
...
.method public onMeasure(II)V
    ...
    iget-object p2, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopup:Lt/L;
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-direct {v0, p0}, Landroidx/appcompat/widget/a;-><init>(Landroidx/appcompat/widget/AppCompatSpinner;)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-interface {p0}, Lt/L;->isShowing()Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mForwardingListener:Lt/j0;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0, p1}, Lt/j0;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public seslDismissPopup()V
    ...
    invoke-interface {p0}, Lt/L;->dismiss()V
...
.method public seslGetPopupWindow()Landroid/widget/PopupWindow;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mListPopupWindow:Lt/q0;

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Lt/q0;->seslGetPopupWindow()Landroid/widget/PopupWindow;
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    iput-object p1, v1, Lt/I;->a:Landroid/widget/SpinnerAdapter;
    ...
    iput-object v2, v1, Lt/I;->b:Landroid/widget/ListAdapter;
    ...
    :cond_3
    invoke-interface {p0, v1}, Lt/L;->setAdapter(Landroid/widget/ListAdapter;)V
...
.method public setDropDownHorizontalOffset(I)V
    ...
    invoke-interface {v0, p1}, Lt/L;->c(I)V

    iget-object p0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopup:Lt/L;

    invoke-interface {p0, p1}, Lt/L;->setHorizontalOffset(I)V
...
.method public setDropDownVerticalOffset(I)V
    ...
    invoke-interface {v0, p1}, Lt/L;->setVerticalOffset(I)V
...
.method public setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Lt/L;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Lt/L;->b(Ljava/lang/CharSequence;)V
...
.method public showPopup()V
    ...
    invoke-interface {v0, v1, p0}, Lt/L;->d(II)V
