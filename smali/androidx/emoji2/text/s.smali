...
.method public constructor <init>(Landroidx/emoji2/text/r;)V
    ...
    iput-short v0, p0, Landroidx/emoji2/text/s;->c:S

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, Landroidx/emoji2/text/s;->d:F

    const-string v0, "rasterizer cannot be null"

    invoke-static {p1, v0}, LG6/a;->e(Ljava/lang/Object;Ljava/lang/String;)V

    iput-object p1, p0, Landroidx/emoji2/text/s;->b:Landroidx/emoji2/text/r;
...
.method public final draw(Landroid/graphics/Canvas;Ljava/lang/CharSequence;IIFIIILandroid/graphics/Paint;)V
    ...
    :cond_0
    iget-object v3, v0, Landroidx/emoji2/text/s;->e:Landroid/text/TextPaint;
    ...
    iput-object v3, v0, Landroidx/emoji2/text/s;->e:Landroid/text/TextPaint;
    ...
    iget-short v1, v0, Landroidx/emoji2/text/s;->c:S
    ...
    :cond_6
    iget-object v0, v0, Landroidx/emoji2/text/s;->b:Landroidx/emoji2/text/r;

    iget-object v1, v0, Landroidx/emoji2/text/r;->b:Lcom/google/firebase/messaging/q;

    iget-object v3, v1, Lcom/google/firebase/messaging/q;->d:Ljava/lang/Object;
...
.method public final getSize(Landroid/graphics/Paint;Ljava/lang/CharSequence;IILandroid/graphics/Paint$FontMetricsInt;)I
    ...
    iget-object p3, p0, Landroidx/emoji2/text/s;->b:Landroidx/emoji2/text/r;

    invoke-virtual {p3}, Landroidx/emoji2/text/r;->c()Ls1/a;

    move-result-object p4

    const/16 v0, 0xe

    invoke-virtual {p4, v0}, Lf1/L;->b(I)I
    ...
    iget-object v3, p4, Lf1/L;->d:Ljava/lang/Object;

    check-cast v3, Ljava/nio/ByteBuffer;

    iget p4, p4, Lf1/L;->a:I
    ...
    iput p1, p0, Landroidx/emoji2/text/s;->d:F

    invoke-virtual {p3}, Landroidx/emoji2/text/r;->c()Ls1/a;

    move-result-object p1

    invoke-virtual {p1, v0}, Lf1/L;->b(I)I

    move-result p4

    if-eqz p4, :cond_1

    iget-object v0, p1, Lf1/L;->d:Ljava/lang/Object;

    check-cast v0, Ljava/nio/ByteBuffer;

    iget p1, p1, Lf1/L;->a:I
    ...
    invoke-virtual {p1, p3}, Lf1/L;->b(I)I

    move-result p3

    if-eqz p3, :cond_2

    iget-object p4, p1, Lf1/L;->d:Ljava/lang/Object;
    ...
    iget p3, p0, Landroidx/emoji2/text/s;->d:F
    ...
    iput-short p1, p0, Landroidx/emoji2/text/s;->c:S
