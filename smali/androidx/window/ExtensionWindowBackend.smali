...
.method public static synthetic access$200(Landroidx/window/ExtensionWindowBackend;)Landroidx/window/DeviceState;
    .locals 0
...
.method public static synthetic access$202(Landroidx/window/ExtensionWindowBackend;Landroidx/window/DeviceState;)Landroidx/window/DeviceState;
    .locals 0
...
.method public static synthetic access$300(Landroidx/window/ExtensionWindowBackend;)Ljava/util/List;
    .locals 0
...
.method public static synthetic access$400(Landroidx/window/ExtensionWindowBackend;)Ljava/util/HashMap;
    .locals 0
...
.method public static synthetic access$500(Landroidx/window/ExtensionWindowBackend;)Ljava/util/List;
    .locals 0
...
.method public registerDeviceStateChangeCallback(Ljava/util/concurrent/Executor;Le1/a;)V
    .locals 3
    ...
    invoke-direct {v1, p1, p2}, Landroidx/window/ExtensionWindowBackend$DeviceStateChangeCallbackWrapper;-><init>(Ljava/util/concurrent/Executor;Le1/a;)V
...
.method public registerLayoutChangeCallback(Landroid/content/Context;Ljava/util/concurrent/Executor;Le1/a;)V
    .locals 3
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    iget-object v1, p0, Landroidx/window/ExtensionWindowBackend;->mWindowLayoutChangeCallbacks:Ljava/util/List;
    ...
    iget-object v2, v2, Landroidx/window/ExtensionWindowBackend$WindowLayoutChangeCallbackWrapper;->mToken:Landroid/os/IBinder;
    ...
    invoke-direct {v2, p1, p2, p3}, Landroidx/window/ExtensionWindowBackend$WindowLayoutChangeCallbackWrapper;-><init>(Landroid/os/IBinder;Ljava/util/concurrent/Executor;Le1/a;)V
...
.method public unregisterDeviceStateChangeCallback(Le1/a;)V
    .locals 4
    .param p1    # Le1/a;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    iget-object v3, v2, Landroidx/window/ExtensionWindowBackend$DeviceStateChangeCallbackWrapper;->mCallback:Le1/a;
...
.method public unregisterLayoutChangeCallback(Le1/a;)V
    .locals 5
    .param p1    # Le1/a;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    iget-object v4, v3, Landroidx/window/ExtensionWindowBackend$WindowLayoutChangeCallbackWrapper;->mCallback:Le1/a;
