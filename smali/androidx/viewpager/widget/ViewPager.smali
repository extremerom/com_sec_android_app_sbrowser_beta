...
.field private static final sPositionComparator:Lc3/i;


# instance fields
.field private mActivePointerId:I

.field mAdapter:Lc3/a;
...
.field private mInternalPageChangeListener:Lc3/f;
...
.field private mObserver:Lc3/g;

.field private mOffscreenPageLimit:I

.field private mOnPageChangeListener:Lc3/f;
...
.field private final mTempItem:Lc3/c;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/viewpager/widget/ViewPager;->sPositionComparator:Lc3/i;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroidx/viewpager/widget/ViewPager;->mTempItem:Lc3/c;
...
.method public final a(Z)V
    ...
    invoke-virtual {p0, v5}, Landroidx/viewpager/widget/ViewPager;->f(I)Z
    ...
    iget-boolean v5, v4, Lc3/c;->c:Z

    if-eqz v5, :cond_3

    iput-boolean v3, v4, Lc3/c;->c:Z
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    invoke-virtual {p0, v3}, Landroidx/viewpager/widget/ViewPager;->infoForChild(Landroid/view/View;)Lc3/c;

    move-result-object v4

    if-eqz v4, :cond_1

    iget v4, v4, Lc3/c;->b:I
...
.method public addNewItem(II)Lc3/c;
    .locals 2
    ...
    iput p1, v0, Lc3/c;->b:I

    iget-object v1, p0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;

    invoke-virtual {v1, p0, p1}, Lc3/a;->instantiateItem(Landroid/view/ViewGroup;I)Ljava/lang/Object;

    move-result-object v1

    iput-object v1, v0, Lc3/c;->a:Ljava/lang/Object;

    iget-object v1, p0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;

    invoke-virtual {v1, p1}, Lc3/a;->getPageWidth(I)F

    move-result p1

    iput p1, v0, Lc3/c;->d:F
...
.method public addOnAdapterChangeListener(Lc3/e;)V
    .locals 1
    .param p1    # Lc3/e;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public addOnPageChangeListener(Lc3/f;)V
    .locals 1
    .param p1    # Lc3/f;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public addTouchables(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p0, v1}, Landroidx/viewpager/widget/ViewPager;->infoForChild(Landroid/view/View;)Lc3/c;
...
.method public arrowScroll(I)Z
    ...
    invoke-virtual {p0, v1, v2}, Landroidx/viewpager/widget/ViewPager;->c(Landroid/view/View;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v0, v3}, Landroidx/viewpager/widget/ViewPager;->c(Landroid/view/View;Landroid/graphics/Rect;)Landroid/graphics/Rect;
...
.method public final b(I)V
    ...
    iget-object v0, p0, Landroidx/viewpager/widget/ViewPager;->mOnPageChangeListener:Lc3/f;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1}, Lc3/f;->onPageSelected(I)V
    ...
    invoke-interface {v2, p1}, Lc3/f;->onPageSelected(I)V
    ...
    :cond_2
    iget-object p0, p0, Landroidx/viewpager/widget/ViewPager;->mInternalPageChangeListener:Lc3/f;

    if-eqz p0, :cond_3

    invoke-interface {p0, p1}, Lc3/f;->onPageSelected(I)V

    :cond_3
    return-void
.end method

.method public final c(Landroid/view/View;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    .locals 2
...
.method public canScrollHorizontally(I)Z
    ...
    iget-object v0, p0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;
...
.method public computeScroll()V
    ...
    invoke-virtual {p0, v2}, Landroidx/viewpager/widget/ViewPager;->f(I)Z
...
.method public final d()Lc3/c;
    ...
    iget v11, v10, Lc3/c;->b:I

    add-int/2addr v6, v5

    if-eq v11, v6, :cond_2

    iget-object v10, p0, Landroidx/viewpager/widget/ViewPager;->mTempItem:Lc3/c;

    add-float/2addr v2, v4

    add-float/2addr v2, v3

    iput v2, v10, Lc3/c;->e:F

    iput v6, v10, Lc3/c;->b:I

    iget-object v2, p0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;

    invoke-virtual {v2, v6}, Lc3/a;->getPageWidth(I)F

    move-result v2

    iput v2, v10, Lc3/c;->d:F
    ...
    iget v2, v6, Lc3/c;->e:F

    iget v4, v6, Lc3/c;->d:F
    ...
    :cond_5
    iget v4, v6, Lc3/c;->b:I

    iget v7, v6, Lc3/c;->d:F
...
.method public dataSetChanged()V
    ...
    iget-object v8, p0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;

    iget-object v9, v7, Lc3/c;->a:Ljava/lang/Object;

    invoke-virtual {v8, v9}, Lc3/a;->getItemPosition(Ljava/lang/Object;)I
    ...
    invoke-virtual {v1, p0}, Lc3/a;->startUpdate(Landroid/view/ViewGroup;)V
    ...
    iget v8, v7, Lc3/c;->b:I

    iget-object v9, v7, Lc3/c;->a:Ljava/lang/Object;

    invoke-virtual {v1, p0, v8, v9}, Lc3/a;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V

    iget v1, p0, Landroidx/viewpager/widget/ViewPager;->mCurItem:I

    iget v7, v7, Lc3/c;->b:I
    ...
    invoke-virtual {v0, p0}, Lc3/a;->finishUpdate(Landroid/view/ViewGroup;)V
    ...
    iget-boolean v6, v5, Lc3/d;->a:Z

    if-nez v6, :cond_9

    const/4 v6, 0x0

    iput v6, v5, Lc3/d;->c:F
...
.method public final f(I)Z
    ...
    :cond_3
    invoke-virtual {p0}, Landroidx/viewpager/widget/ViewPager;->d()Lc3/c;
    ...
    iget v6, v0, Lc3/c;->b:I

    int-to-float p1, p1

    div-float/2addr p1, v3

    iget v3, v0, Lc3/c;->e:F

    sub-float/2addr p1, v3

    iget v0, v0, Lc3/c;->d:F
...
.method public final g(FF)Z
    ...
    invoke-static {v5, v4, p1}, La3/a;->f(Landroid/widget/EdgeEffect;FF)F
    ...
    invoke-static {v4, v9}, Lcom/sec/android/app/sbrowser/autofill/password/k;->g(ILjava/util/ArrayList;)Ljava/lang/Object;

    move-result-object v9

    check-cast v9, Lc3/c;

    iget v10, v8, Lc3/c;->b:I
    ...
    iget v11, p0, Landroidx/viewpager/widget/ViewPager;->mFirstOffset:F
    ...
    :goto_5
    iget v8, v9, Lc3/c;->b:I

    iget-object v12, p0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;

    invoke-virtual {v12}, Lc3/a;->getCount()I
    ...
    invoke-static {v0, p1, v7}, La3/a;->f(Landroid/widget/EdgeEffect;FF)F
    ...
    invoke-static {v2, v5, p2}, La3/a;->f(Landroid/widget/EdgeEffect;FF)F
    ...
    invoke-virtual {p0, v0}, Landroidx/viewpager/widget/ViewPager;->f(I)Z
...
.method public getAdapter()Lc3/a;
    .locals 0
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    iget-object p0, p0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;
...
.method public final h(IIII)V
    ...
    invoke-virtual {p0, p2}, Landroidx/viewpager/widget/ViewPager;->infoForPosition(I)Lc3/c;

    move-result-object p2

    if-eqz p2, :cond_3

    iget p2, p2, Lc3/c;->e:F
...
.method public infoForAnyChild(Landroid/view/View;)Lc3/c;
    .locals 1
    ...
    :cond_1
    invoke-virtual {p0, p1}, Landroidx/viewpager/widget/ViewPager;->infoForChild(Landroid/view/View;)Lc3/c;
...
.method public infoForChild(Landroid/view/View;)Lc3/c;
    .locals 4
    ...
    invoke-virtual {v2, p1, v3}, Lc3/a;->isViewFromObject(Landroid/view/View;Ljava/lang/Object;)Z
...
.method public infoForPosition(I)Lc3/c;
    .locals 3
...
.method public initViewPager(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p1, p0}, LL8/a;-><init>(Landroidx/viewpager/widget/ViewPager;)V
...
.method public final j(IIZZ)V
    ...
    invoke-virtual {p0, p1}, Landroidx/viewpager/widget/ViewPager;->infoForPosition(I)Lc3/c;
    ...
    invoke-static {v3, v4, v5}, LG5/L3;->d(FFF)F
    ...
    invoke-virtual {p0, v3, v1, p2}, Landroidx/viewpager/widget/ViewPager;->smoothScrollTo(III)V
    ...
    invoke-virtual {p0, v3}, Landroidx/viewpager/widget/ViewPager;->f(I)Z
...
.method public final l()V
    ...
    sget-object v0, Landroidx/viewpager/widget/ViewPager;->sPositionComparator:Lc3/i;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;
    ...
    iget v10, v10, Lc3/c;->b:I

    :goto_0
    if-ge v9, v10, :cond_6

    :goto_1
    iget v11, v5, Lc3/c;->b:I
    ...
    invoke-virtual/range {p0 .. p0}, Landroidx/viewpager/widget/ViewPager;->k()Z
    ...
    :cond_2
    iget-object v11, v0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;

    invoke-virtual {v11, v9}, Lc3/a;->getPageWidth(I)F
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v3, v6, Landroidx/viewpager/widget/ViewPager;->mDragInGutterEnabled:Z
    ...
    invoke-virtual {p0, v10, v12}, Landroidx/viewpager/widget/ViewPager;->g(FF)Z
    ...
    invoke-static {v0, v2, v3}, La3/a;->f(Landroid/widget/EdgeEffect;FF)F
    ...
    invoke-static {v0, v2, v1}, La3/a;->f(Landroid/widget/EdgeEffect;FF)F
...
.method public onLayout(ZIIII)V
    ...
    iget-boolean v14, v12, Lc3/d;->a:Z

    if-eqz v14, :cond_6

    iget v12, v12, Lc3/d;->b:I
    ...
    check-cast v10, Lc3/d;

    iget-boolean v13, v10, Lc3/d;->a:Z

    if-nez v13, :cond_a

    invoke-virtual {v0, v9}, Landroidx/viewpager/widget/ViewPager;->infoForChild(Landroid/view/View;)Lc3/c;
    ...
    :goto_6
    iget-boolean v13, v10, Lc3/d;->d:Z

    if-eqz v13, :cond_9

    const/4 v13, 0x0

    iput-boolean v13, v10, Lc3/d;->d:Z

    iget v10, v10, Lc3/d;->c:F
    ...
    invoke-virtual {v0, v1, v2, v2, v2}, Landroidx/viewpager/widget/ViewPager;->j(IIZZ)V
...
.method public onMeasure(II)V
    ...
    iget-boolean v7, v3, Lc3/d;->a:Z

    if-eqz v7, :cond_b

    iget v7, v3, Lc3/d;->b:I
    ...
    iget-boolean v6, v4, Lc3/d;->a:Z

    if-nez v6, :cond_d

    int-to-float v6, p1

    iget v4, v4, Lc3/d;->c:F
...
.method public onPageScrolled(IFI)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lc3/f;->onPageScrolled(IFI)V
    ...
    invoke-static {v1, v3, v4}, Lt/b;->l(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-interface {v3, p1, p2, p3}, Lc3/f;->onPageScrolled(IFI)V
    ...
    :cond_8
    iget-object v0, p0, Landroidx/viewpager/widget/ViewPager;->mInternalPageChangeListener:Lc3/f;
...
.method public onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0, v5}, Landroidx/viewpager/widget/ViewPager;->infoForChild(Landroid/view/View;)Lc3/c;

    move-result-object v6

    if-eqz v6, :cond_1

    iget v6, v6, Lc3/c;->b:I
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v0, v2, v1}, Lc3/a;->restoreState(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {p0}, Lc3/a;->saveState()Landroid/os/Parcelable;
...
.method public onSizeChanged(IIII)V
    ...
    invoke-virtual {p0, p1, p3, p2, p2}, Landroidx/viewpager/widget/ViewPager;->h(IIII)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, p1, v2, v1, v2}, Landroidx/viewpager/widget/ViewPager;->j(IIZZ)V
    ...
    invoke-virtual {p0, v2, p1}, Landroidx/viewpager/widget/ViewPager;->g(FF)Z
    ...
    iget v5, p0, Landroidx/viewpager/widget/ViewPager;->mMaximumVelocity:I
    ...
    iget v9, v7, Lc3/c;->e:F

    sub-float/2addr v9, v6

    iget v6, v7, Lc3/c;->d:F
    ...
    :goto_3
    iget v4, p0, Landroidx/viewpager/widget/ViewPager;->mLeftIncr:I
    ...
    invoke-static {v1, v4}, Lcom/sec/android/app/sbrowser/autofill/password/k;->g(ILjava/util/ArrayList;)Ljava/lang/Object;
    ...
    invoke-static {p1, v2, v4}, LG5/L3;->e(III)I
...
.method public populate(I)V
    ...
    :cond_1
    :goto_0
    invoke-virtual {v0, v2}, Landroidx/viewpager/widget/ViewPager;->infoForPosition(I)Lc3/c;
    ...
    invoke-virtual {v1, v0}, Lc3/a;->startUpdate(Landroid/view/ViewGroup;)V
    ...
    iget-object v7, v0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;

    invoke-virtual {v7}, Lc3/a;->getCount()I
    ...
    invoke-virtual {v0, v9, v8}, Landroidx/viewpager/widget/ViewPager;->addNewItem(II)Lc3/c;
    ...
    :cond_b
    iget v10, v12, Lc3/c;->b:I

    if-ne v6, v10, :cond_f

    iget-boolean v10, v12, Lc3/c;->c:Z
    ...
    iget-object v10, v0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;

    iget-object v12, v12, Lc3/c;->a:Ljava/lang/Object;

    invoke-virtual {v10, v0, v6, v12}, Lc3/a;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v6, v10}, Landroidx/viewpager/widget/ViewPager;->addNewItem(II)Lc3/c;

    move-result-object v10

    iget v10, v10, Lc3/c;->d:F
    ...
    :cond_13
    iget v13, v6, Lc3/c;->b:I

    if-ne v11, v13, :cond_17

    iget-boolean v13, v6, Lc3/c;->c:Z
    ...
    iget-object v13, v0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;

    iget-object v6, v6, Lc3/c;->a:Ljava/lang/Object;

    invoke-virtual {v13, v0, v11, v6}, Lc3/a;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    :cond_16
    invoke-virtual {v0, v11, v12}, Landroidx/viewpager/widget/ViewPager;->addNewItem(II)Lc3/c;
    ...
    invoke-virtual {v1}, Lc3/a;->getCount()I
    ...
    iget v3, v2, Lc3/c;->b:I

    iget v7, v9, Lc3/c;->b:I

    if-ge v3, v7, :cond_1c

    iget v7, v2, Lc3/c;->e:F

    iget v2, v2, Lc3/c;->d:F
    ...
    invoke-virtual {v11, v3}, Lc3/a;->getPageWidth(I)F
    ...
    :goto_17
    iput v7, v0, Landroidx/viewpager/widget/ViewPager;->mLastOffset:F
    ...
    :goto_19
    iget v12, v7, Lc3/c;->b:I

    if-le v10, v12, :cond_22

    iget-object v12, v0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;

    add-int/lit8 v13, v10, -0x1

    invoke-virtual {v12, v10}, Lc3/a;->getPageWidth(I)F
    ...
    :cond_22
    iget v13, v7, Lc3/c;->d:F

    add-float/2addr v13, v6

    sub-float/2addr v3, v13

    iput v3, v7, Lc3/c;->e:F
    ...
    invoke-virtual {v10, v7}, Lc3/a;->getPageWidth(I)F
    ...
    :cond_26
    iput v3, v8, Lc3/c;->e:F

    iget v8, v8, Lc3/c;->d:F
    ...
    iget-object v3, v9, Lc3/c;->a:Ljava/lang/Object;

    invoke-virtual {v1, v0, v2, v3}, Lc3/a;->setPrimaryItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V

    :cond_28
    iget-object v1, v0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;

    invoke-virtual {v1, v0}, Lc3/a;->finishUpdate(Landroid/view/ViewGroup;)V
    ...
    iput v2, v5, Lc3/d;->f:I

    iget-boolean v6, v5, Lc3/d;->a:Z

    if-nez v6, :cond_29

    iget v6, v5, Lc3/d;->c:F
    ...
    invoke-virtual {v0, v3}, Landroidx/viewpager/widget/ViewPager;->infoForChild(Landroid/view/View;)Lc3/c;

    move-result-object v3

    if-eqz v3, :cond_2a

    iget v6, v3, Lc3/c;->d:F

    iput v6, v5, Lc3/d;->c:F

    iget v3, v3, Lc3/c;->b:I

    iput v3, v5, Lc3/d;->e:I
    ...
    invoke-virtual {v0, v1}, Landroidx/viewpager/widget/ViewPager;->infoForAnyChild(Landroid/view/View;)Lc3/c;
    ...
    invoke-virtual {v0, v1}, Landroidx/viewpager/widget/ViewPager;->infoForChild(Landroid/view/View;)Lc3/c;
    ...
    invoke-static {v3, v4, v5, v7, v6}, Lt/b;->A(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    iget-object v0, v0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;
...
.method public removeOnAdapterChangeListener(Lc3/e;)V
    .locals 0
    .param p1    # Lc3/e;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public removeOnPageChangeListener(Lc3/f;)V
    .locals 0
    .param p1    # Lc3/f;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public setAdapter(Lc3/a;)V
    .locals 7
    .param p1    # Lc3/a;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {v0, v1}, Lc3/a;->setViewPagerObserver(Landroid/database/DataSetObserver;)V

    iget-object v0, p0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;

    invoke-virtual {v0, p0}, Lc3/a;->startUpdate(Landroid/view/ViewGroup;)V
    ...
    iget-object v5, p0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;

    iget v6, v4, Lc3/c;->b:I

    iget-object v4, v4, Lc3/c;->a:Ljava/lang/Object;

    invoke-virtual {v5, p0, v6, v4}, Lc3/a;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    :cond_3
    iput-object p1, p0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;

    iput v3, p0, Landroidx/viewpager/widget/ViewPager;->mExpectedAdapterCount:I

    if-eqz p1, :cond_7

    iget-object v0, p0, Landroidx/viewpager/widget/ViewPager;->mObserver:Lc3/g;

    if-nez v0, :cond_4

    new-instance v0, Lc3/g;

    invoke-direct {v0, p0}, Lc3/g;-><init>(Landroidx/viewpager/widget/ViewPager;)V

    iput-object v0, p0, Landroidx/viewpager/widget/ViewPager;->mObserver:Lc3/g;

    :cond_4
    iget-object v0, p0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;

    iget-object v4, p0, Landroidx/viewpager/widget/ViewPager;->mObserver:Lc3/g;

    invoke-virtual {v0, v4}, Lc3/a;->setViewPagerObserver(Landroid/database/DataSetObserver;)V
    ...
    iget-object v4, p0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;

    invoke-virtual {v4}, Lc3/a;->getCount()I
    ...
    invoke-virtual {v0, v4, v5}, Lc3/a;->restoreState(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
    ...
    iget-object v2, v1, LJ6/c;->b:Lcom/google/android/material/tabs/TabLayout;

    iget-object v4, v2, Lcom/google/android/material/tabs/TabLayout;->d0:Landroidx/viewpager/widget/ViewPager;

    if-ne v4, p0, :cond_8

    iget-boolean v1, v1, LJ6/c;->a:Z

    invoke-virtual {v2, p1, v1}, Lcom/google/android/material/tabs/TabLayout;->s(Lc3/a;Z)V
...
.method public setCurrentItemInternal(IZZI)V
    ...
    invoke-virtual {p0, p1, p4, p2, v1}, Landroidx/viewpager/widget/ViewPager;->j(IIZZ)V
...
.method public setOnPageChangeListener(Lc3/f;)V
    .locals 0
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation

    iput-object p1, p0, Landroidx/viewpager/widget/ViewPager;->mOnPageChangeListener:Lc3/f;
...
.method public setPageMargin(I)V
    ...
    invoke-virtual {p0, v1, v1, p1, v0}, Landroidx/viewpager/widget/ViewPager;->h(IIII)V
...
.method public setScrollState(I)V
    ...
    invoke-interface {v0, p1}, Lc3/f;->onPageScrollStateChanged(I)V
    ...
    invoke-interface {v2, p1}, Lc3/f;->onPageScrollStateChanged(I)V
    ...
    invoke-interface {p0, p1}, Lc3/f;->onPageScrollStateChanged(I)V
...
.method public smoothScrollTo(III)V
    ...
    invoke-virtual {p0, v2}, Landroidx/viewpager/widget/ViewPager;->a(Z)V
    ...
    :cond_4
    iget-object p2, p0, Landroidx/viewpager/widget/ViewPager;->mAdapter:Lc3/a;

    iget p3, p0, Landroidx/viewpager/widget/ViewPager;->mCurItem:I

    invoke-virtual {p2, p3}, Lc3/a;->getPageWidth(I)F
