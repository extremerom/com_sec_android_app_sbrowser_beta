...
.method public constructor <init>(LG3/j;)V
    ...
    iput-object v0, p0, LB3/n;->c:Landroid/graphics/Path;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, LB3/n;->d:Ljava/util/ArrayList;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object p1, p0, LB3/n;->e:LG3/j;
...
.method public final a(Landroid/graphics/Path$Op;)V
    ...
    iget-object v0, p0, LB3/n;->b:Landroid/graphics/Path;

    invoke-virtual {v0}, Landroid/graphics/Path;->reset()V

    iget-object v1, p0, LB3/n;->a:Landroid/graphics/Path;

    invoke-virtual {v1}, Landroid/graphics/Path;->reset()V

    iget-object v2, p0, LB3/n;->d:Ljava/util/ArrayList;
    ...
    invoke-virtual {v5}, LB3/e;->g()Ljava/util/List;
    ...
    invoke-interface {v8}, LB3/o;->e()Landroid/graphics/Path;

    move-result-object v8

    iget-object v9, v5, LB3/e;->k:LC3/q;
    ...
    :cond_0
    iget-object v9, v5, LB3/e;->c:Landroid/graphics/Matrix;
    ...
    instance-of v4, v2, LB3/e;

    if-eqz v4, :cond_5

    check-cast v2, LB3/e;

    invoke-virtual {v2}, LB3/e;->g()Ljava/util/List;
    ...
    iget-object v6, v2, LB3/e;->k:LC3/q;
    ...
    :cond_4
    iget-object v6, v2, LB3/e;->c:Landroid/graphics/Matrix;
    ...
    :cond_6
    iget-object p0, p0, LB3/n;->c:Landroid/graphics/Path;
...
.method public final b(Ljava/util/List;Ljava/util/List;)V
    ...
    :goto_0
    iget-object v1, p0, LB3/n;->d:Ljava/util/ArrayList;
    ...
    invoke-interface {v1, p1, p2}, LB3/d;->b(Ljava/util/List;Ljava/util/List;)V
...
.method public final e()Landroid/graphics/Path;
    ...
    iget-object v0, p0, LB3/n;->c:Landroid/graphics/Path;

    invoke-virtual {v0}, Landroid/graphics/Path;->reset()V

    iget-object v1, p0, LB3/n;->e:LG3/j;

    iget-boolean v2, v1, LG3/j;->b:Z
    ...
    iget-object v1, v1, LG3/j;->a:LG3/i;
    ...
    invoke-virtual {p0, v1}, LB3/n;->a(Landroid/graphics/Path$Op;)V
